...
class AppConstants {
  ...
  static const String getNoestSettingsUri =
      '/api/v3/seller/shipping-method/noest-settings';
  static const String saveNoestSettingsUri =
      '/api/v3/seller/shipping-method/noest-settings';
  static const String testNoestConnectionUri =
      '/api/v3/seller/shipping-method/test-noest-connection';
  ...
  static const String currentMonthCommissionInvoiceUri =
      '/api/v3/seller/commission/current-month';
  static const String sendCommissionReceiptUri =
      '/api/v3/seller/commission/invoices/';
