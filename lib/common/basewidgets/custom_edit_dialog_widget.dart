...
class CustomEditDialogWidgetState extends State<CustomEditDialogWidget> {
  ...
  void initState() {
    ...
    _balanceController.text = PriceConverter.convertPriceWithoutSymbol(
        Get.context!, widget.totalEarning);
    _listenTextController();

    if (walletController.methodSelected != null) {
      walletController.setMethodTypeIndex(walletController.methodSelected,
          notify: false);
    }
  }
              ...
              children: [
                    ...
                    child: Column(
                      children: [
                            ...
                            content: RichText(
                              text: TextSpan(
                                ...
                                children: <InlineSpan>[
                                  TextSpan(
                                      text: getTranslated(
                                              'you_have_setup_any_payment_information',
                                              context) ??
                                          ''),
                                  WidgetSpan(
                        ...
                        Container(
                          ...
                          child: DropdownButton<MethodModel>(
                              hint: Text(getTranslated(
                                      'select_withdraw_method', context) ??
                                  ''),
                              value: (dropdownItems.isEmpty
                                  ? null
                                  : withdraw.methodSelected),
                              items: dropdownItems,
                        ...
                        if (withdraw.methodList.isNotEmpty &&
                            ...
                            withdraw.methodSelected!.methodInfo!.isNotEmpty &&
                            withdraw.methodSelected?.type == 'my_methods')
                          Container(
                              ...
                              children: [
                                ...
                                Container(
                                    ...
                                    child: Table(
                                      ...
                                      children: [
                                        for (var methodInfo in withdraw
                                                .methodSelected
                                                ?.methodInfo
                                                ?.entries ??
                                            {}.entries) ...[
                        ...
                        if (withdraw.methodList.isNotEmpty &&
                            ...
                            withdraw.methodSelected!.methodFields!.isNotEmpty &&
                            withdraw.methodSelected?.type == 'other')
                          ListView.builder(
                              physics: const NeverScrollableScrollPhysics(),
                              shrinkWrap: true,
                              itemCount:
                                  withdraw.methodSelected?.methodFields?.length,
                              itemBuilder: (context, index) {
                                String? type = withdraw.methodSelected
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      CustomTextFieldWidget(
                                        ...
                                        hintText: withdraw.methodSelected
                ...
                Padding(
                  ...
                  child: CustomTextFieldWidget(
                    ...
                    border: true,
                    labelText:
                        getTranslated('enter_withdraw_amount', context) ?? '',
                    hintText:
                        getTranslated('enter_withdraw_amount', context) ?? '',
                    inputFormatters: [
                    ...
                    ? Consumer<WalletController>(
                        ...
                        return InkWell(
                          ...
                          onTap: () {
                            ...
                            if (withdraw.methodSelected == null) {
                            ...
                            } else if (withdraw.methodSelected?.type ==
                                    'my_methods' &&
                                withdraw.methodSelected?.methodFields != null &&
                                withdraw.inputFieldControllerList.isEmpty) {
                              Navigator.of(context).pop();
                              showCustomSnackBarWidget(
                                  getTranslated(
                              ...
                              showCustomSnackBarWidget(
                                  getTranslated(
                                      'withdraw_amount_should_be_grater_then',
                                      context),
                                  context,
                                  isToaster: true,
                                  sanckBarType: SnackBarType.warning);
                          ...
                          child: Card(
                            color: double.parse(_balanceController.text != ''
                                        ? _balanceController.text
                                        : '0') <=
                                    0
  ...
  void withdrawBalance() async {
    ...
    if (balance.isEmpty) {
      ...
      showCustomSnackBarWidget(getTranslated('enter_balance', context), context,
          isToaster: true, sanckBarType: SnackBarType.warning);
    } else if (bal >
