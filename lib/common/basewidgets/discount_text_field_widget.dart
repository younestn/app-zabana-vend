...
class ProductDiscountTextFieldWidget extends StatefulWidget {
  ...
  @override
  State<ProductDiscountTextFieldWidget> createState() =>
      _ProductDiscountTextFieldWidgetState();
}

class _ProductDiscountTextFieldWidgetState
    extends State<ProductDiscountTextFieldWidget> {
        ...
        decoration: InputDecoration(
          ...
          suffixIcon: Container(
            ...
            child: Row(
              ...
              children: [
                Text(_isDiscountAmount
                    ? splashProvider.myCurrency!.symbol ?? ''
                    : '%'),
                ...
                PopupMenuButton<int>(
                  ...
                  onSelected: (value) {
                    _toggleDiscountType();
                    widget.onDiscountTypeChanged!(
                        _isDiscountAmount ? 'amount' : 'percent');
                  },
                  itemBuilder: (context) => [
                    PopupMenuItem(
                      value: 1,
