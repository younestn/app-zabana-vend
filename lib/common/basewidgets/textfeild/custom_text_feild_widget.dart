      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
                    ...
                    child: Container(
                        ...
                        decoration: BoxDecoration(
                            borderRadius: BorderRadius.only(
                              topLeft: Provider.of<LocalizationController>(
                                          context,
                                          listen: false)
                                      .isLtr
                                  ? Radius.circular(widget.focusedBorderRadius)
                                  : const Radius.circular(0),
                              bottomLeft: Provider.of<LocalizationController>(
                                          context,
                                          listen: false)
                                      .isLtr
                                  ? Radius.circular(widget.focusedBorderRadius)
                                  : const Radius.circular(0),
                              topRight: Provider.of<LocalizationController>(
                                          context,
                                          listen: false)
                                      .isLtr
                                  ? const Radius.circular(0)
                                  : Radius.circular(widget.focusedBorderRadius),
                              bottomRight: Provider.of<LocalizationController>(
                                          context,
                                          listen: false)
                                      .isLtr
                                  ? const Radius.circular(0)
                            ...
                            color: widget.showIconDecorationColor!
                                ? Theme.of(context)
                                    .primaryColor
                                    .withValues(alpha: 0.135)
                                : null),
                        child: CustomAssetImageWidget(widget.prefixIconImage!,
                            width: 20, height: 20)),
                  ))
          ...
          suffixIcon: widget.suffixIconImage != null
              ? Padding(
                  ...
                  child: Container(
                      ...
                      child: Image.asset(widget.suffixIconImage!,
                          width: 20, height: 20)))
              : widget.isPassword
                  ? GestureDetector(
                      onTap: _toggle,
          ...
          contentPadding: EdgeInsets.symmetric(
              vertical: 12.0, horizontal: widget.variant ? 0 : 10),
