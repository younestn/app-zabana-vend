...
import 'package:sixvalley_vendor_app/features/shop/widgets/vendor_badge_widget.dart';
...
class ShopCardWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Consumer<ShopController>(builder: (context, shopInfo, child) {
      ...
      final sellerBadge = shopInfo.shopModel?.sellerBadge ??
          profileController.userInfoModel?.sellerBadge;
                ...
                child: SizedBox(
                  ...
                  child: ClipRRect(
                      ...
                      child: CustomImageWidget(
                          image: '${shopInfo.shopModel?.bannerFullUrl?.path}')),
                ),
              ),
              Padding(
                          ...
                          children: [
                            Text(shopInfo.shopModel?.name ?? '',
                                style: robotoBold.copyWith(
                                    ...
                                    height: 1.0)),
                            const SizedBox(
                                height: Dimensions.paddingSizeVeryTiny),
                            Text(
                      ...
                      child: Row(
                        children: [
                          ShopInfoCard(
                            ...
                            count:
                                shopInfo.shopModel?.totalProducts.toString() ??
                                    '0',
                          ...
                          ShopInfoCard(
                            ...
                            count: shopInfo.shopModel?.totalOrder.toString() ??
                                '0',
                            image: Images.orderIcon,
                            color: ColorHelper.darken(
                                Theme.of(context).colorScheme.onSecondary, 0.1),
                          ),
                          const SizedBox(width: Dimensions.paddingSizeSmall),
                          ShopInfoCard(
                            width: 110,
                            title: getTranslated('reviews', context) ?? '',
                            count: shopInfo.shopModel?.totalReview.toString() ??
                                '0',
                          ...
                          const SizedBox(width: Dimensions.paddingSizeSmall),
                          if (shopInfo.shopModel?.taxIdentificationNumber !=
                                  null &&
                              shopInfo.shopModel?.tinExpireDate != null)
                            ConstrainedBox(
            ...
            Positioned(
              ...
              child: SizedBox(
                ...
                child: ClipRRect(
                    ...
                    child: CustomImageWidget(
                        image: '${shopInfo.shopModel?.imageFullUrl?.path}')),
              ),
            ),
          ]),
        ),
