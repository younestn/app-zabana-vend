    ...
    return PreferredSize(
      ...
      child: Container(
        ...
        child: AppBar(
          ...
          centerTitle: false,
          leading:
              Consumer<ShopController>(builder: (context, shopInfo, child) {
            return IconButton(
          ...
          actions: [
            Padding(
                ...
                child: InkWell(
                    ...
                    child: const CustomAssetImageWidget(Images.storeWebIcon,
                        width: 25, height: 25))),
          ],
          bottom: PreferredSize(
            preferredSize:
                const Size.fromHeight(40), // Height of the additional content
            child: Padding(
