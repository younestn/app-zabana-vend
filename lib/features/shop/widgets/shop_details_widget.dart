    ...
    return Consumer<ShopController>(builder: (context, shopInfo, child) {
      return Padding(
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              if (shopInfo.showAddProductWarning &&
                  shopInfo.shopModel?.totalProducts != null &&
                  ((shopInfo.shopModel?.totalProducts ?? 0) < 1))
                Padding(
                    ...
                    content: RichText(
                      text: TextSpan(
                        ...
                        children: <InlineSpan>[
                          TextSpan(
                              text: getTranslated(
                                      'manage_your_shop_decoration', context) ??
                                  ''),
                          const WidgetSpan(
                              child:
                    ...
                    text: TextSpan(
                      ...
                      children: <InlineSpan>[
                        if (!(shopInfo.shopModel!.temporaryClose ?? false)) ...[
                          TextSpan(
                              text: getTranslated(
                                      'your_shop_is_currently', context) ??
                                  ''),
                          TextSpan(
                            text: getTranslated(
                                    'shop_availability_status', context) ??
                                '',
                            style: const TextStyle(fontWeight: FontWeight.bold),
                          ),
                          TextSpan(
                              text: getTranslated('is_turned_off', context) ??
                                  ''),
                        ],
                        if ((shopInfo.shopModel?.temporaryClose ?? false) &&
                            !(shopInfo.shopModel?.vacationStatus ?? false)) ...[
                          TextSpan(
                            text: getTranslated(
                                    'your_shop_is_running_up_do_date',
                                    context) ??
                                '',
                        ...
                        if ((shopInfo.shopModel?.vacationStatus ?? false) &&
                          ...
                          TextSpan(
                            text: getTranslated(
                                    'you_have_scheduled_shop', context) ??
                                '',
                            style: robotoRegular.copyWith(
                                color: Theme.of(context).colorScheme.error),
                          ),
                          TextSpan(
                            text: DateConverter.localToIsoString(
                                DateTime.tryParse(
                          ...
                          TextSpan(
                            text: getTranslated(
                                    'if_you_wish_to_reopen_your_shop',
                                    context) ??
                                '',
                            style: robotoRegular.copyWith(
                                color: Theme.of(context).colorScheme.error),
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                                getTranslated('store_availability', context) ??
                                    '',
                            ...
                            const SizedBox(height: Dimensions.paddingSizeSmall),
                            Text(
                                getTranslated('turning_off_the_status_will',
                                        context) ??
                                    '',
                                style: robotoRegular.copyWith(
                                    color: Theme.of(context)
                            ...
                            shopInfo.shopModel != null
                                ? ShopSettingWidget(
                                    title: 'statuss',
                                    mode: shopInfo.shopModel?.temporaryClose !=
                                            null
                                        ? shopInfo.shopModel!.temporaryClose
                                        : false,
                                    onTap: (value) {
                                      showModalBottomSheet(
                                          ...
                                          builder: (con) =>
                                              StatusChangeBottomSheetWidget(
                                                title: !(shopInfo.shopModel
                                                            ?.temporaryClose ??
                                                        false)
                                                    ? ((getTranslated(
                                                            'do_you_want_to_make_your_store_unavailable',
                                                            context) ??
                                                        ''))
                                                    : (getTranslated(
                                                            'do_you_want_to_make_your_store',
                                                            context) ??
                                                        ''),
                                                subtitle: !(shopInfo.shopModel
                                                            ?.temporaryClose ??
                                                        false)
                                                    ? getTranslated(
                                                        'turning_on_the_status_will_deactivate',
                                                        context)
                                                    : getTranslated(
                                                        'turning_on_the_status_will_activate',
                                                        context),
                                                onNoPressed: () {},
                                                onYesPressed: () {
                      ...
                      Opacity(
                        opacity: !(shopInfo.shopModel?.temporaryClose ?? false)
                            ? 0.4
                            : 1.0,
                        child: IgnorePointer(
                          ignoring:
                              ...
                              children: [
                                Row(
                                  children: [
                                    ...
                                    if (shopInfo.shopModel?.vacationStatus ??
                                        false)
                                      Text(
                                ...
                                Text(
                                    getTranslated('if_you_turn_on_your_shop',
                                            context) ??
                                        '',
                                    style: robotoRegular.copyWith(
                                        color: Theme.of(context)
                                ...
                                CustomButtonWidget(
                                    ...
                                    btnTxt: getTranslated(
                                        'setup_vacation_mode', context),
                                    onTap: () {
                                      Navigator.of(context).push(
                                          MaterialPageRoute(
                                              builder: (_) =>
                                                  const VacationModeScreen()));
                                    }),
                              ],
                            ),
                          ),
