                        ...
                        child: Column(
                          children: [
                            ...
                            (widget.isDetails &&
                                    widget.productModel?.productType ==
                                        'digital' &&
                                    widget.productModel?.previewFileFullUrl !=
                                        null &&
                                    widget.productModel?.previewFileFullUrl
                                            ?.path !=
                                        '')
                              ...
                              Container(
                                  ...
                                  decoration: BoxDecoration(
                                      borderRadius: BorderRadius.circular(
                                          Dimensions.paddingSizeExtraSmall),
                                      color:
                                          widget.productModel!.requestStatus ==
                                                  0
                                        ...
                                        Row(children: [
                                          ...
                                          Text(
                                              ...
                                              style: robotoMedium.copyWith(
                                                  color: ColorHelper.blendColors(
                                                      Colors.white, Theme.of(context).textTheme.bodyLarge!.color!, 0.7))),
                                          const SizedBox(
                                              width: Dimensions
                                                  .paddingSizeExtraSmall),
                        ...
                        onTap: () async {
                          ...
                          Navigator.of(Get.context!).push(MaterialPageRoute(
                              builder: (_) => BarCodeGenerateScreen(
                                  product: widget.productModel)));
                          Provider.of<BarcodeController>(Get.context!,
                                  listen: false)
