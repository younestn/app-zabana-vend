...
class VacationModeScreenState extends State<VacationModeScreen> {
  ...
  void initState() {
    super.initState();
    shopController.setVacationDurationType(
        shopController.vacationModel?.vacationDurationType ?? 'one_day',
        isUpdate: false);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBarWidget(
          title: getTranslated('vacation_mode_setup', context)),
                      ...
                      children: [
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(
                                  getTranslated('vacation_mode', context) ?? '',
                          ...
                          child: Column(
                              ...
                              children: [
                                TitledBorder(
                                              ...
                                              (Set<WidgetState> states) {
                                                if (states.contains(
                                                  ...
                                                  return Theme.of(context)
                                                      .primaryColor; // so inner fill doesn't interfere
                                                }
                                                return Theme.of(context)
                                                    .hintColor
                                  ...
                                  title: getTranslated(
                                          'vacation_duration_type', context) ??
                                      '',
                                ),
                                if (shopController.vacationDurationType !=
                                    'until_change')
                                  const SizedBox(
                                  ...
                                  Row(
                                    children: [
                                      Expanded(
                                        ...
                                        text: shopController.startDateTime !=
                                                null
                                            ? shopController.dateFormat
                                                .format(shopController
                                                    .startDateTime!)
                                                .toString()
                                            : shopController.vacationModel
                                                        ?.vacationStartDate !=
                                                    null
                                                ? shopController.dateFormat
                                      ...
                                      Expanded(
                                        ...
                                        text: shopController.endDateTime != null
                                            ? shopController.dateFormat
                                                .format(
                                                    shopController.endDateTime!)
                                                .toString()
                                            : (shopController.vacationModel
                                                            ?.vacationEndDate !=
                                                        null &&
                                                    DateTime.tryParse(shopController
                                                            .vacationModel!
                                                            .vacationEndDate!) !=
                                                        null)
                                                ? shopController.dateFormat.format(
                                                    DateTime.parse(shopController
                                                            .vacationModel
                                                            ?.vacationEndDate ??
                                                        ''))
                                                : getTranslated(
                                ...
                                CustomTextFieldWidget(
                                  ...
                                  hintText:
                                      getTranslated('type_your_note', context),
                                  labelText:
                                      getTranslated('vacation_note', context),
                                ...
                                Row(
                                  ...
                                  children: [
                                    Text(
                                        _vacationNoteController.text.length
                                            .toString(),
                                        style: robotoRegular.copyWith(
                                            color: _vacationNoteController
                                                        .text.length >=
                                                    100
                                                ? Theme.of(context)
                                                    .colorScheme
                            ...
                            Expanded(
                              child: shopProvider.isLoading
                                  ...
                                  : CustomButtonWidget(
                                      ...
                                      onTap: () {
                                        if (_vacationNoteController.text.length >
                                            100) {
                                          showCustomSnackBarWidget(
                                              getTranslated(
                                                  'vacation_note_is_too_large',
                                                  context),
                                              context,
                                              sanckBarType:
                                                  SnackBarType.warning);
                                        } else if ((shopProvider
                                                        .vacationDurationType ==
                                                    'one_day' ||
                                                shopProvider
                                                        .vacationDurationType ==
                                          ...
                                          shopController.shopVacation(
                                              context,
                                              VacationModel(
                                                  vacationStatus: shopController
                                                      .vacationModel
                                                      ?.vacationStatus,
                                                  vacationNote:
                                                      _vacationNoteController
                                                          .text,
                                                  vacationDurationType:
                                                      shopController
                                                          .vacationDurationType,
      ...
      children: [
        Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
                color: borderColor ?? Theme.of(context).hintColor, width: 1.5),
          ),
          child: content,
        ),
        Positioned(
