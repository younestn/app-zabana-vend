    ...
    return Scaffold(
      body: Padding(
        ...
        child:
          ...
          return shopController.paymentInformationModel == null
              ? const PaymentMethodListShimmer()
              : Column(
                  children: [
                    Expanded(
                            ...
                            Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  (shopController.paymentInformationModel !=
                                              null &&
                                          (shopController
                                      ...
                                      : PaginatedListViewWidget(
                                          ...
                                          totalSize: shopController
                                                  .paymentInformationModel
                                                  ?.totalSize ??
                                              0,
                                          offset: shopController
                                                  .paymentInformationModel
                                                  ?.offset ??
                                              0,
                    ...
                    if (shopController.paymentInformationModel != null &&
                        (shopController.paymentInformationModel?.data ?? [])
                            .isNotEmpty)
                      CustomButtonWidget(
                        btnTxt:
                            getTranslated('add_payment_info', context) ?? '',
                        onTap: () {
                          Navigator.push(
                              context,
                              MaterialPageRoute(
...
TableRow _buildTableRow(String label, String value) {
  return TableRow(
    children: [
      Text(formatField(label),
          style: robotoMedium.copyWith(
              color: Theme.of(Get.context!).textTheme.headlineLarge?.color,
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          const Row(children: []),
          const CustomAssetImageWidget(Images.paymentMethodWarningIcon,
              width: 45, height: 45),
          const SizedBox(height: Dimensions.paddingSizeSmall),
          Text(getTranslated('no_payment_info', context) ?? '',
          ...
          InkWell(
            onTap: () {
              Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (_) => const AddPaymentInfoScreen()));
            },
            child: Container(
              decoration: BoxDecoration(
                ...
                children: [
                  Container(
                      ...
                      child: Icon(Icons.add,
                          color: Provider.of<ShopController>(context,
                                          listen: false)
                                      .withdrawalMethodModel ==
                                  null
                  ...
                  Text(getTranslated('add_payment_info', context) ?? '',
                      style: robotoRegular.copyWith(
          ...
          children: [
            Row(
              ...
              children: [
                Expanded(
                  child: Row(
                    ...
                    children: [
                      Flexible(
                        child: Text(
                          shopController.paymentInformationModel?.data?[index]
                                  .methodName ??
                              '',
                          style: robotoBold.copyWith(
                              color:
                      ...
                      const SizedBox(width: Dimensions.paddingSizeSmall),
                      if (shopController.paymentInformationModel?.data?[index]
                              .isDefault ??
                          false)
                        Container(
                          padding: const EdgeInsets.all(
                          ...
                          child: Text(getTranslated('default', context) ?? '',
                              style: robotoMedium.copyWith(
                                  color: Theme.of(context)
                                      .colorScheme
                                      .onTertiaryContainer,
                ...
                PopupMenuButton<int>(
                  ...
                  onSelected: (value) {
                    if (value == 2) {
                      shopController.setDefaultPaymentMethod(shopController
                              .paymentInformationModel?.data?[index].id ??
                          0);
                    } else if (value == 3) {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (_) => AddPaymentInfoScreen(
                                  formUpdate: true,
                                  paymentInfoData: shopController
                                      .paymentInformationModel?.data?[index])));
                    } else if (value == 4 &&
                        shopController.paymentInformationModel?.data?[index]
                                .isDefault ==
                            false) {
                      shopController.deletePaymentMethodStatus(
                          shopController
                                  .paymentInformationModel?.data?[index].id ??
                              0,
                          index);
                  ...
                  itemBuilder: (context) => [
                        ...
                        children: [
                          ...
                          Consumer<ShopController>(
                            ...
                            return FlutterSwitch(
                              ...
                              height: 20.0,
                              toggleSize: 18.0,
                              value: shopController.paymentInformationModel
                                      ?.data?[index].isActive ??
                                  false,
                              borderRadius: 20.0,
                                    ...
                                    builder: (con) =>
                                        StatusChangeBottomSheetWidget(
                                          ...
                                          subtitle: getTranslated(
                                              'turning_on_this_status_will_make',
                                              context),
                                          onNoPressed: () {},
                                          onYesPressed: () {
                                            shopController
                    ...
                    PopupMenuItem(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text(
                            getTranslated('mark_as_default', context)!,
                            style: robotoRegular.copyWith(
                                fontSize: Dimensions.fontSizeDefault,
                                color: Theme.of(context)
                                    .textTheme
                          ...
                          const CustomAssetImageWidget(Images.defaultMarkIcon,
                              width: 20, height: 20)
                        ],
                      ),
                    ),
                      ...
                      PopupMenuItem(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            const SizedBox(width: 10),
                            CustomAssetImageWidget(Images.myShopEditIcon,
                                width: 20,
                                height: 20,
                      ...
                      child: Row(
                        ...
                        children: [
                          Text(
                            ...
                            style: robotoRegular.copyWith(
                                fontSize: Dimensions.fontSizeDefault,
                                color: (shopController.paymentInformationModel
                          ...
                          const SizedBox(width: 10),
                          Opacity(
                            opacity: (shopController.paymentInformationModel
                                        ?.data![index].isDefault ??
                                    false)
                                ? 0.5
                                : 1.0,
            ...
            Container(
                ...
                child: Table(
                  columnWidths: const {
                    0: FixedColumnWidth(
                        100), // Fixed width for the label column
                  },
                  children: [
                    for (var methodInfo in shopController
                            .paymentInformationModel
                            ?.data?[index]
                            .methodInfo
                            ?.entries ??
