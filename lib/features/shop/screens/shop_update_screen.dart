  ...
  Future<void> _updateShop() async {
    ...
    if (Provider.of<ShopController>(context, listen: false).shopModel?.name ==
      ...
      if (Provider.of<ShopController>(context, listen: false)
          ...
          Provider.of<ShopController>(context, listen: false)
                  .shopModel
                  ?.setupGuideApp?['shop_setup'] !=
              1) {
        Provider.of<ShopController>(context, listen: false)
            .updateTutorialFlow('shop_setup');
        Provider.of<ShopController>(context, listen: false)
            .updateSetupGuideApp('shop_setup', 1);
      }
                                  ...
                                  style: DefaultTextStyle.of(context)
                                      ...
                                      .copyWith(
                                          color: Theme.of(context)
                                              ...
                                              ?.color),
                                  children: <InlineSpan>[
                                    if (!(shopInfo.shopModel!.temporaryClose ??
                                        false)) ...[
                                      TextSpan(
                                          text: getTranslated(
                                                  'your_shop_is_currently',
                                                  context) ??
                                              ''),
                                      TextSpan(
                                        text: getTranslated(
                                                'shop_availability_status',
                                                context) ??
                                            '',
                                    ...
                                    if ((shopInfo.shopModel?.vacationStatus ??
                                      ...
                                      TextSpan(
                                        text: DateConverter.localToIsoString(
                                            DateTime.tryParse(shopInfo.shopModel
                                                        ?.vacationStartDate ??
                                                    '') ??
                                                DateTime.now()),
                                        style: TextStyle(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              CustomTextFieldWidget(
                                ...
                                hintText:
                                    getTranslated('contact_number', context),
                                showCodePicker: true,
                                        ...
                                        child: DottedBorder(
                                          ...
                                          child: Container(
                                            ...
                                            child: Stack(children: [
                                              ...
                                              if (authProvider.shopBanner ==
                                                      null &&
                                                  (shop.shopModel?.bannerFullUrl
                                                          ?.path?.isEmpty ??
                                                      true))
                                                Positioned(
                                                  bottom: 0,
