...
class _OtherSetupScreenState extends State<OtherSetupScreen> {
  ...
  final TextEditingController _freeDeliveryOverAmountController =
      TextEditingController();
  ...
  void setInitialData() {
    if (splashController.configModel?.minimumOrderAmountStatus == 1 &&
        splashController.configModel?.minimumOrderAmountStatusBySeller == 1) {
      _minimumOrderAmountController.text =
          profileController.userInfoModel?.minimumOrderAmount?.toString() ?? '';
    }

    if (splashController.configModel?.freeDeliveryStatus == 1 &&
        splashController.configModel?.freeDeliveryResponsibility == 'seller') {
      freeDeliveryOn =
          profileController.userInfoModel?.freeOverDeliveryAmountStatus == 1
              ? true
              : false;
      _minimumOrderAmountController.text =
          profileController.userInfoModel?.freeOverDeliveryAmount?.toString() ??
              '';
    }

    if (shopController.shopModel?.taxIdentificationNumber != null) {
      _tinNumberController.text =
          shopController.shopModel?.taxIdentificationNumber ?? '';
    }

    if (shopController.shopModel?.tinExpireDate != null &&
        ShopModel.sanitizeApiDate(shopController.shopModel?.tinExpireDate) !=
            null) {
      shopController.setExpireDate(
        DateConverter.safeIsoStringToLocalDate(
            shopController.shopModel?.tinExpireDate),
      );
    } else {
    ...
    if (shopController.shopModel?.reorderLevel != null) {
      _reOrderLevelController.text =
          shopController.shopModel?.reorderLevel.toString() ?? '';
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Consumer<ShopController>(builder: (context, shopController, child) {
        return Column(
          children: [
            Expanded(
              child: Padding(
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                                getTranslated(
                                        'here_you_can_configure_the_settings',
                                        context) ??
                                    '',
                            ...
                            if (splashController
                              ...
                              TitledBorder(
                                title:
                                    '${getTranslated('free_delivery_over_amount', context)}',
                                content: Padding(
                                  padding: const EdgeInsets.symmetric(
                                      horizontal: Dimensions.paddingSizeSmall),
                            ...
                            CustomTextFieldWidget(
                              ...
                              hintText:
                                  getTranslated('re_order_level', context),
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            CustomTextFieldWidget(
                              ...
                              // nextNode: _freeDeliveryOverAmountFocus,
                              hintText:
                                  '${getTranslated('taxpayer_identification_number', context)}',
                            ...
                            TitledBorder(
                              title:
                                  getTranslated('expire_date', context) ?? '',
                              content: Padding(
                                  padding: const EdgeInsets.symmetric(
                                      horizontal: Dimensions.paddingSizeSmall),
                                  child: Row(
                                    children: [
                                      Expanded(
                                        child: Text(
                                          DateConverter
                                                  .safeIsoStringToLocalDateOnly(
                                            shopController.tinExpireDate
                                                ?.toIso8601String(),
                                          ).isNotEmpty
                                              ? DateConverter
                                                  .safeIsoStringToLocalDateOnly(
                                      ...
                                      InkWell(
                                        onTap: () async {
                                          await shopController
                                              .pickTinExpireDate(context);
                                        },
                                        child: const CustomAssetImageWidget(
                                            Images.pickTinExpireDate,
                                            width: 20,
                                            height: 20),
                                      ),
                                    ],
                            ...
                            const SizedBox(
                                height: Dimensions.paddingSizeDefault),
                            Text(
                                getTranslated('tin_certificate', context) ?? '',
                            ...
                            DottedBorder(
                                options: RoundedRectDottedBorderOptions(
                                  ...
                                  color:
                                      shopController.tinCertificateFile != null
                                ...
                                child: Container(
                                    ...
                                    child: Stack(
                                      children: [
                                        if (shopController.tinCertificateFile !=
                                            null)
                                          Positioned(
                                              top: 10,
                                              right: 10,
                                              child: InkWell(
                                                  ...
                                                  child: shopController
                                                      ...
                                                      : Image.asset(
                                                          width: 25,
                                                          Images
                                                              .digitalPreviewDeleteIcon))),
                                        if (shopController
                                                    .tinCertificateFile ==
                                                null &&
                                            shopController.shopModel
                                                    ?.tinCertificateFullUrl !=
                                                null &&
                                            shopController
                                                    .shopModel
                                                    ?.tinCertificateFullUrl
                                          ...
                                          Positioned(
                                            ...
                                            child: shopController
                                                ...
                                                : InkWell(
                                                    onTap: () {
                                                      shopController.previewDownload(
                                                          url: shopController
                                                                  .shopModel
                                                                  ?.tinCertificateFullUrl
                                                                  ?.path ??
                                                    ...
                                                    children: [
                                                      SizedBox(
                                                          ...
                                                          child: InkWell(
                                                              onTap: () =>
                                                                  shopController
                                                                      .pickTinCertificateFile(),
                                                              child: const CustomAssetImageWidget(
                                                                  Images
                                                                      .tinCertificateUploadIcon,
                                                                  width: 45,
                                                                  height: 45))),
                                                      const SizedBox(
                                                          height: Dimensions
                          ...
                          child: shopProvider.isLoading
                              ...
                              : CustomButtonWidget(
                                  ...
                                  onTap: () {
                                    ...
                                    if (freeDeliveryOn &&
                                        _freeDeliveryOverAmountController
                                            .text.isEmpty) {
                                      showCustomSnackBarWidget(
                                          getTranslated(
                                              'free_delivery_over_amount_is_empty',
                                              context),
                                          sanckBarType: SnackBarType.warning,
                                          context,
                                          isError: false);
                                    } else if (_reOrderLevelController.text
                                        .trim()
                                        .isEmpty) {
                                      showCustomSnackBarWidget(
                                          getTranslated(
                                              'reorder_level_is_empty',
                                              context),
                                          sanckBarType: SnackBarType.warning,
                                          context,
                                          isError: false);
                                    } else {
                                      if (Provider.of<ShopController>(context,
                                                      listen: false)
                                                  .shopModel
                                                  ?.setupGuideApp !=
                                              null &&
                                        ...
                                        Provider.of<ShopController>(context,
                                                listen: false)
                                            .updateTutorialFlow('order_setup');
                                        Provider.of<ShopController>(context,
                                                listen: false)
                                            .updateSetupGuideApp(
                                                'order_setup', 1);
                                      ...
                                      shopProvider.updateShopInfo(
                                          ...
                                          taxIdentificationNumber:
                                              _tinNumberController.text,
                                          tinExpireDate: shopController
                                              .tinExpireDate
                                              .toString(),
                                          tinCertificate:
                                              shopController.tinCertificateFile,
                                          stockLimit:
                                              _reOrderLevelController.text);
                                    }
                                  }),
