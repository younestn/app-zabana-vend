...
class RestockSheetWidgetState extends State<RestockSheetWidget> {
  ...
  void initState() {
    ...
    Provider.of<RestockController>(context, listen: false)
        .initVariationController(widget.product!.variation ?? []);
                ...
                return Consumer<RestockController>(
                  ...
                  return Consumer<AddProductController>(
                    ...
                    widget.stockQuantityController!.text =
                        restockController.totalQuantityController.text;
                                                                    ...
                                                                    children: [
                                                                      Text.rich(
                                                                        TextSpan(
                                                                          children: [
                                                                            TextSpan(
                                                                                text: widget.product?.variation![index].type ?? '',
                                                                ...
                                                                child: Column(
                                                                  ...
                                                                  children: [
                                                                    CustomTextFieldWidget(
                                                                      ...
                                                                      controller:
                                                                          restockController
                                                                              .variationQuantityController[index],
                                                                      focusNode:
                                                                          restockController
                                                                              .variationQuantityFocusnode[index],
                                                                      nextNode: index !=
                                                                              widget.product!.variation!.length -
                                                                                  1
                                                                          ? restockController.variationQuantityFocusnode[index +
                                                                              1]
                                                                          : null,
                                                                      textInputAction: index !=
                                                                              variationController.variantTypeList.length -
                                                                                  1
                                                                          ? TextInputAction
                                                                              .next
                                                                          : TextInputAction
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                  ...
                                  children: [
                                    ...
                                    const SizedBox(
                                        width: Dimensions.paddingSizeSmall),
                                    Consumer<RestockController>(builder:
                                        (context, shippingProvider, child) {
