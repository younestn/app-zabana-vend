            ...
            child: Consumer<RestockController>(
              ...
              return InkWell(
                onTap: () async {
                  ...
                  await restockProvider.deleteRestockListItem(
                      widget.data!.id!, widget.index);
                ...
                child: Container(
                  ...
                  width: 30,
                  padding:
                      const EdgeInsets.all(Dimensions.paddingSizeOrder + 1),
                  decoration: BoxDecoration(
                      borderRadius:
                ...
                return Consumer<VariationController>(
                  ...
                  return InkWell(
                    onTap: () {
                      if (widget.product!.variation != null &&
                        ...
                        _stockQuantityController!.text =
                            widget.product?.currentStock.toString() ?? '0';
                        showModalBottomSheet(
                          ...
                          builder: (con) => RestockSheetWidget(
                              ...
                              title:
                                  getTranslated('product_variations', context),
                              ...
                              onYesPressed: () {
                                ...
                                if (variationController
                                  ...
                                  for (int i = 0;
                                      ...
                                      i++) {
                                    if (variationController.variantTypeList[i]
                                                .qtyController.text ==
                                            '' &&
                                        !isEmpty) {
                                      isEmpty = true;
                                ...
                                if (isEmpty) {
                                  showCustomSnackBarWidget(
                                    ...
                                    .isEmpty) {
                                  showCustomSnackBarWidget(
                                      'product_quantity_is_required', context);
                                  if (kDebugMode) {
                                    print(widget.product!.id);
                                  }
                                } else {
                                  restockProvider.updateRestockProductQuantity(
                                      context,
                                      widget.product?.id,
                    ...
                    child: Container(
                      ...
                      width: 30,
                      padding:
                          const EdgeInsets.all(Dimensions.paddingSizeOrder),
                      decoration: BoxDecoration(
                          borderRadius: BorderRadius.circular(
