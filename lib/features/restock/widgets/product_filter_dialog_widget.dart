  ...
  Widget build(BuildContext context) {
    ...
    return Dismissible(
      ...
      child: Consumer<RestockController>(
          builder: (context, restockProvider, child) {
        return Container(
          constraints:
              BoxConstraints(maxHeight: size.height * 0.8, minHeight: 150),
            ...
            children: [
                      ...
                      Text(getTranslated('filter', context) ?? '',
                          style: titilliumSemiBold.copyWith(
                              ...
                              color: Theme.of(context)
                                  ...
                                  .bodyLarge
                                  ?.color)),
                      (restockProvider.startDate != null ||
                              restockProvider.selectedBrandIds.isNotEmpty)
                          ? InkWell(
                              onTap: () async {
                                showDialog(
                                    context: context,
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // Brand
                      if (restockProvider.brands != null &&
                          (restockProvider.brands?.isNotEmpty ?? false))
                        Padding(
                            ...
                            child: ListView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  return CategoryFilterItem(
                                      title:
                                          restockProvider.brands![index].name,
                                      count: restockProvider
                                          .brands![index].productCount
                                          .toString(),
                                      checked: restockProvider
                                          .brands![index].checked!,
                                      onTap: () => restockProvider
              ...
              Padding(
                ...
                child: CustomButtonWidget(
                  ...
                  backgroundColor: (restockProvider.startDate == null &&
                          restockProvider.selectedBrandIds.isEmpty)
                      ? Theme.of(context).hintColor
                      : null,
                  onTap: () {
                    if (restockProvider.startDate == null &&
                        restockProvider.selectedBrandIds.isEmpty) {
                      showCustomSnackBarWidget(
                          '${getTranslated('select_date_or_brand', context)}',
                          context,
                          isToaster: true);
                    } else {
