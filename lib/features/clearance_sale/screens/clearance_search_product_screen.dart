...
class ClearanceSearchProductScreen extends StatefulWidget {
  ...
  @override
  State<ClearanceSearchProductScreen> createState() =>
      _ClearanceSearchProductScreenState();
}

class _ClearanceSearchProductScreenState
    extends State<ClearanceSearchProductScreen> {
        ...
        child: Container(
          ...
          child: AppBar(
            ...
            title: Column(
              ...
              children: [
                Text(
                  getTranslated('clearance_sale', context)!,
      ...
      body: Consumer<ClearanceSaleController>(
        ...
        return Column(
          children: [
            ...
            Expanded(
              ...
              child: Column(
                  ...
                  children: [
                    ...
                    ListView.builder(
                      itemCount:
                          clearanceSaleController.selectedProductModel?.length,
                      padding: const EdgeInsets.all(0),
                      physics: const NeverScrollableScrollPhysics(),
                      shrinkWrap: true,
                      itemBuilder: (BuildContext context, int index) {
                        return ClearanceAddListItem(
                          product: clearanceSaleController
                              .selectedProductModel![index],
                          index: index,
            ...
            Opacity(
              opacity: clearanceSaleController.selectedProductModel!.isEmpty
                  ? 0.5
                  : 1.0,
              child: AbsorbPointer(
                absorbing:
                    clearanceSaleController.selectedProductModel!.isEmpty,
                child: Container(
                    padding:
                    ...
                    child: Row(children: [
                      ...
                      Expanded(
                          child: clearanceSaleController.isLoading
                              ...
                              : CustomButtonWidget(
                                  btnTxt:
                                      getTranslated('add_products', context),
                                  onTap: () {
                                    bool isWrongAmount = false;

                                    for (ClearanceSaleAddModel product
                                        in clearanceSaleController
                                    ...
                                    if (clearanceSaleController
                                      ...
                                      showCustomSnackBarWidget(
                                          getTranslated(
                                              'some_product_contains_wrong_amount',
                                              context),
                                          context,
                                          isError: false,
