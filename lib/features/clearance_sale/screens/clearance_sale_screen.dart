        ...
        child: FloatingActionButton(
          ...
          onPressed: () {
            Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (_) => const ClearanceSearchProductScreen()));
          },
        ),
      ),
                ...
                child: Row(
                  children: [
                    Expanded(
                        child: Text(
                            getTranslated(
                                'show_your_offer_in_the_store_details',
                                context)!,
                    ...
                    FlutterSwitch(
                      ...
                      toggleSize: 18.0,
                      value:
                          clearanceController.clearanceConfigModel?.isActive ==
                              1,
                      borderRadius: 20.0,
                      ...
                      onToggle: (bool isActive) async {
                        if (isActive &&
                            clearanceController.clearanceConfigModel?.id ==
                                null) {
                          showCustomSnackBarWidget(
                              getTranslated(
                                  'please_setup_the_configuration_first',
                                  context),
                              context,
                          ...
                          _debounce.run(
                            () async {
                              ...
                              await clearanceController
                                  .updateConfigStatus(isActive ? 1 : 0);
              ...
              child: Opacity(
                ...
                child: Column(children: [
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            ...
                            if (clearanceController.clearanceSaleProductModel !=
                                    null &&
                                clearanceController.clearanceSaleProductModel!
                                    .products!.isNotEmpty &&
                                clearanceController
                                        .clearanceSaleProductModel?.totalSize !=
                                    0) ...[
                              const SizedBox(
                  ...
                  clearanceController.clearanceSaleProductModel != null
                      ? clearanceController
                              .clearanceSaleProductModel!.products!.isNotEmpty
                          ? PaginatedListViewWidget(
                              reverse: false,
                              scrollController: scrollController,
                              totalSize: clearanceController
                                      .clearanceSaleProductModel?.totalSize ??
                                  0,
                              offset: clearanceController
                                  .clearanceSaleProductModel?.offset,
                              onPaginate: (int? offset) async {
                                clearanceController
                                    .getClearanceSaleProductList(offset!);
                                if (kDebugMode) {
                                  print('========offset======>$offset');
                                }
                              },
                              itemView: ListView.builder(
                                itemCount: clearanceController
                                        .clearanceSaleProductModel
                                        ?.products
                                        ?.length ??
                                    0,
                                ...
                                itemBuilder: (BuildContext context, int index) {
                                  return ClearanceProductWidget(
                                      products: clearanceController
                                          .clearanceSaleProductModel!
                                          .products![index],
                                      index: index);
                                },
                          ...
                          : Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    getTranslated(
                                        'add_product_show_in_the_clearance',
                                        context)!,
