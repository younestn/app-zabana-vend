...
class DeleteConfirmationDialogWidget extends StatelessWidget {
  ...
  final int? index;
  const DeleteConfirmationDialogWidget(this.clearanceId, this.index,
      {super.key});
                  ...
                  children: [
                    Column(mainAxisSize: MainAxisSize.min, children: [
                      ...
                      SizedBox(
                        width: 52,
                        height: 52,
                        child: Image.asset(clearanceId != null
                            ? Images.clearanceSingleRemove
                            : Images.clearanceAllRemove),
                      ),
                      Padding(
                        ...
                        child: Text(
                            clearanceId == null
                                ? getTranslated(
                                    'are_you_sure_remove_all_item', context)!
                                : getTranslated(
                                    'are_you_sure_remove_this_item', context)!,
                      ...
                      Padding(
                        ...
                        child: Text(
                            clearanceId == null
                                ? getTranslated(
                                    'once_you_remove_all_item', context)!
                                : getTranslated(
                                    'once_you_remove_the_item', context)!,
                                          ...
                                          onTap: () async {
                                            if (clearanceId != null) {
                                              await Provider.of<
                                                      ...
                                                      context,
                                                      listen: false)
                                                  .deleteClearanceSaleProductList(
                                                      clearanceId, index);
                                            } else {
                                              await Provider.of<
                                                          ClearanceSaleController>(
