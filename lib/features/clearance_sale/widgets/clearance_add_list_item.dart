...
class _ClearanceAddListItemState extends State<ClearanceAddListItem> {
  ...
  void initState() {
    if (widget.product.variation != null &&
      ...
      result = Provider.of<ClearanceSaleController>(Get.context!, listen: false)
          .getMinMaxValues(widget.product.variation ?? []);
    }
                        ...
                        children: [
                          ...
                          if (clearanceSaleController
                            ...
                            ClearanceProductDiscountTextFieldWidget(
                                formProduct: true,
                                border: true,
                                controller: clearanceSaleController
                                    .clearanceSaleAddModel[widget.index]
                                    .amountController,
                                ...
                                onChanged: (value) {
                                  TextEditingController controller =
                                      clearanceSaleController
                                          .clearanceSaleAddModel[widget.index]
                                          .amountController;
                                  String discountType = clearanceSaleController
                                      .clearanceSaleAddModel[widget.index]
                                      .type!;

                                  _validateDiscountAmount(controller, context,
                                      clearanceSaleController, discountType);
                                },
                                onDiscountTypeChanged: (String value) {
                                  clearanceSaleController
                                      .setSelectedProductDiscountType(
                                          widget.index, value);
              ...
              child: InkWell(
                ...
                child: Container(
                  ...
                  child: Icon(Icons.close,
                      size: 17, color: Theme.of(context).cardColor),
                ),
              )),
        ],
      );
  ...
  void _validateDiscountAmount(
      TextEditingController controller,
      BuildContext context,
      ClearanceSaleController clearanceSaleController,
      String discountType) {
    if (controller.text.isEmpty) {
      setState(() {
        ...
        isWrongAmount = true;
        clearanceSaleController
            .clearanceSaleAddModel[widget.index].isWrongAmount = true;
      });
    } else if (hasVariation &&
        discountType == 'amount' &&
        double.tryParse(controller.text)! <
            PriceConverter.convertAmount(result.minPrice, context)) {
      setState(() {
        errorText =
            getTranslated('discount_amount_cannot_less_product_price', context);
        isWrongAmount = true;
        clearanceSaleController
            .clearanceSaleAddModel[widget.index].isWrongAmount = true;
      });
        ...
        discountType == 'amount' &&
        double.tryParse(controller.text)! >
            PriceConverter.convertAmount(result.maxPrice, context)) {
      setState(() {
        errorText = getTranslated(
            'discount_amount_cannot_grater_then_product_price', context);
        isWrongAmount = true;
        clearanceSaleController
            .clearanceSaleAddModel[widget.index].isWrongAmount = true;
      });
        ...
        discountType == 'amount' &&
        PriceConverter.convertAmount(widget.product.unitPrice ?? 0, context) <
            double.tryParse(controller.text)!) {
      setState(() {
        errorText = getTranslated(
            'discount_amount_cannot_grater_then_product_price', context);
      ...
      setState(() {
        isWrongAmount = false;
        clearanceSaleController
            .clearanceSaleAddModel[widget.index].isWrongAmount = false;
      });
    }
  }
}
