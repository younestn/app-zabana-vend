            ...
            child: Autocomplete<Product>(
              ...
              optionsBuilder: (TextEditingValue textEditingValue) async {
                ...
                if (textEditingValue.text.isEmpty ||
                    clearanceController.sellerProductModel?.products == null) {
                  return const Iterable<Product>.empty();
                } else {
                  Iterable<Product> matchingProducts = clearanceController
                      .sellerProductModel!.products!
                      .where((product) => (product.name!
                              .toLowerCase()
                              .contains(textEditingValue.text.toLowerCase()) &&
                          (!clearanceController.selectedProductIds!
                              .contains(product.id))));
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return InkWell(
                                onTap: () {
                                  ...
                                  clearanceController.setSelectedProduct(
                                      product, index);
                                },
                                child: Padding(
                                          ...
                                          borderRadius: BorderRadius.only(
                                            ...
                                            topLeft: index == 0
                                                ? const Radius.circular(
                                                    Dimensions.radiusDefault)
                                                : Radius.zero,
                                            bottomLeft: options.length - 1 ==
                                                    index
                                                ? const Radius.circular(
                                                    Dimensions.radiusDefault)
                                                : Radius.zero,
                                            bottomRight: options.length - 1 ==
                                                    index
                                                ? const Radius.circular(
                                                    Dimensions.radiusDefault)
                                                : Radius.zero,
