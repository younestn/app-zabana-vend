...
class ClearanceProductDiscountTextFieldWidget extends StatefulWidget {
  ...
  @override
  State<ClearanceProductDiscountTextFieldWidget> createState() =>
      _ClearanceProductDiscountTextFieldWidgetState();
}

class _ClearanceProductDiscountTextFieldWidgetState
    extends State<ClearanceProductDiscountTextFieldWidget> {
        ...
        decoration: InputDecoration(
          ...
          suffixIcon: Container(
            ...
            child: Row(
              ...
              children: [
                Text(_isClearanceDiscountAmount
