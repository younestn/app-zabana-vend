          ...
          childrens: [
                ...
                children: [
                  Expanded(
                    ...
                    text: clearanceController.startDate != null
                        ? clearanceController.dateFormat
                            .format(clearanceController.startDate!)
                            .toString()
                  ...
                  Expanded(
                    ...
                    text: clearanceController.endDate != null
                        ? clearanceController.dateFormat
                            .format(clearanceController.endDate!)
                            .toString()
                        : getTranslated('select_date', context),
                    selectDate: () =>
                        clearanceController.selectDate("end", context),
                  )),
                ],
              ),
            ),
                      ...
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: Radio<int>(
                            value: 1,
                            groupValue:
                                clearanceController.selectedDiscountType,
                            onChanged: (value) {
                              clearanceController
                        ...
                        const SizedBox(width: Dimensions.paddingSizeSmall),
                        Text(getTranslated('flat_discount', context)!,
                  ...
                  Expanded(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        const SizedBox(width: Dimensions.paddingSizeSmall),
                        Text(getTranslated('product_wise_discount', context)!,
                            style: robotoTitleRegular.copyWith(
                                fontSize: Dimensions.fontSizeSmall,
                                color: Theme.of(context)
                                    .textTheme
            ...
            if (clearanceController.selectedDiscountType == 1) ...[
              Padding(
                  ...
                  child: Text(getTranslated('discount_amount', context)!,
                      style: robotoMedium.copyWith(
                          fontSize: Dimensions.fontSizeDefault,
                          color:
                      ...
                      children: [
                        Expanded(
                          child: CustomTextFieldWidget(
                              border: true,
                              controller:
                                  clearanceController.discountController,
                              // focusNode: _taxNode,
                      ...
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: Radio<int>(
                            value: 1,
                            groupValue:
                                clearanceController.selectedOfferActiveType,
                            onChanged: (value) {
                              clearanceController
                                  .setSelectedOfferActiveType(value!);
                            },
                          ),
                        ),
                        const SizedBox(width: Dimensions.paddingSizeSmall),
                        Text(getTranslated('always_active', context)!,
                            style: robotoTitleRegular.copyWith(
                                fontSize: Dimensions.fontSizeSmall,
                                color: Theme.of(context)
                                    .textTheme
                  ...
                  Expanded(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        const SizedBox(width: Dimensions.paddingSizeSmall),
                        Text(getTranslated('specific_time_in_a_day', context)!,
                            style: robotoTitleRegular.copyWith(
                                fontSize: Dimensions.fontSizeSmall,
                                color: Theme.of(context)
                                    .textTheme
                    ...
                    child: Row(
                      children: [
                        ...
                        TimePickerWidget(
                          ...
                          onTimeChanged: (time) =>
                              clearanceController.setServiceEndTime = time,
                        ),
                      ],
                    ),
                  )
                                  ...
                                  onTap: () {
                                    if (clearanceController.startDate == null) {
                                      showCustomSnackBarWidget(
                                          ...
                                          context,
                                          isError: false);
                                    } else if (clearanceController.endDate ==
                                        null) {
                                      showCustomSnackBarWidget(
                                          getTranslated(
                                          ...
                                          context,
                                          isError: false);
                                    } else if (!clearanceController
                                        .isEndDateValid(
                                            clearanceController.startDate!,
                                            clearanceController.endDate!)) {
                                      showCustomSnackBarWidget(
                                          getTranslated(
                                          ...
                                          isError: false);
                                                ...
                                                .selectedOfferActiveType ==
                                            2 &&
                                        (clearanceController.offerStartTime ==
                                                null ||
                                            clearanceController
                                                    .offerStartTime ==
                                                null)) {
                                      showCustomSnackBarWidget(
                                          ...
                                          isError: false);
                                                ...
                                                .selectedOfferActiveType ==
                                            2 &&
                                        !clearanceController.isEndTimeValid(
                                            clearanceController.offerStartTime!,
                                            clearanceController
                                                .offerEndTime!)) {
                                      showCustomSnackBarWidget(
                                          getTranslated(
                                              'end_time_cannot_be', context),
                                          sanckBarType: SnackBarType.warning,
                                          context,
                                          isError: false);
                                    } else {
                                      clearanceController
                                          .saveClearanceConfigData();
                                    }
                                  },
                                )),
                    ]))
