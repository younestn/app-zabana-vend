...
class _ClearanceProductWidgetState extends State<ClearanceProductWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.products.product?.clearanceSale?.discountType == 'flat' ||
        widget.products.product?.clearanceSale?.discountType == 'amount') {
      double minVariationPrice = (widget.products.product?.variation != null &&
              widget.products.product!.variation!.isNotEmpty)
          ? Provider.of<ClearanceSaleController>(Get.context!, listen: false)
              .getVariationMinimumPrice(
                  digitalVariation: null,
                  physicalVariation: widget.products.product!.variation)
          : (widget.products.product?.digitalVariation != null &&
                  widget.products.product!.digitalVariation!.isNotEmpty)
              ? Provider.of<ClearanceSaleController>(Get.context!,
                      listen: false)
                  .getVariationMinimumPrice(
                      digitalVariation:
                          widget.products.product!.digitalVariation,
                      physicalVariation: null)
              : 0;
      ...
      String discountedPrice = PriceConverter.convertPriceWithoutSymbol(
          context, widget.products.product!.unitPrice,
          discountType:
      ...
      if (double.parse(discountedPrice) < minVariationPrice &&
          (0 > double.parse(discountedPrice))) {
                ...
                onPressed: (value) {
                  showDialog(
                      ...
                      builder: (_) => DeleteConfirmationDialogWidget(
                          widget.products.productId, widget.index));
                },
                backgroundColor:
                      ...
                      Container(
                        ...
                        child: ClipRRect(
                            ...
                            child: CustomImageWidget(
                                image: widget.products.product?.thumbnailFullUrl
                                        ?.path ??
                                    '')),
                      ),
                        ...
                        return PopupMenuButton<int>(
                          ...
                          onSelected: (value) {
                            if (value == 2) {
                              showDialog(
                                  context: context,
                                  builder: (_) => ClearanceProductUpdateWidget(
                                      widget.products));
                            } else if (value == 3) {
                              showDialog(
                                  context: context,
                          ...
                          itemBuilder: (context) => [
                            PopupMenuItem(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Consumer<ClearanceSaleController>(builder:
                                      (context, clearanceController, child) {
                                    return FlutterSwitch(
                                      ...
                                      onToggle: (bool isActive) {
                                        if (showAmountAlert) {
                                          ...
                                          clearanceController
                                              .updateClearanceSaleProductStatus(
                                                  widget.products.productId!,
                                                  isActive ? 1 : 0,
                                                  widget.index!);
                                        }
                            ...
                            if (clearanceController
                                    .clearanceConfigModel?.discountType !=
                                'flat') ...[
                              PopupMenuItem(
                                value: 2,
                                child: Row(
                                  ...
                                  children: [
                                    Text(
                                      getTranslated('edit_discount', context)!,
                                      style: robotoRegular.copyWith(
                                          fontSize: Dimensions.fontSizeDefault,
                                          color: Theme.of(context)
                                              .textTheme
                            ...
                            PopupMenuItem(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Text(
                                    getTranslated('delete_product', context)!,
                                    style: robotoRegular.copyWith(
                                        fontSize: Dimensions.fontSizeDefault,
                                        color: Theme.of(context)
                                            .textTheme
                    ...
                    children: [
                        ...
                        children: [
                          ...
                          Wrap(
                            children: [
                              ...
                              Text(
                                widget.products.product!.category?.name ?? '',
                                style: robotoRegular.copyWith(
                                    fontSize: Dimensions.fontSizeDefault,
                                    color: Theme.of(context)
                                        .textTheme
                              ...
                              if (widget.products.product?.productType ==
                                ...
                                Text(
                                  widget.products.product?.brand?.name ?? '',
                                  style: robotoRegular.copyWith(
                                      fontSize: Dimensions.fontSizeDefault,
                                      color: Theme.of(context)
                                          .textTheme
                      ...
                      Container(
                        ...
                        child: Column(
                            ...
                            children: [
                              Text(
                                widget.products.discountType == 'percentage'
                                    ? '${widget.products.discountAmount}%'
