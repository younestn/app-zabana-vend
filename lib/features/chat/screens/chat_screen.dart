      ...
      body: Consumer<ChatController>(builder: (context, chatController, child) {
        return Column(children: [
          ...
          chatController.messageModel != null
              ? Expanded(
                  child: (chatController.messageModel!.message != null &&
                          chatController.messageModel!.message!.isNotEmpty)
                      ? SingleChildScrollView(
                          ...
                          child: PaginatedListViewWidget(
                            ...
                            onPaginate: (int? offset) async =>
                                await chatController.getMessageList(
                                    widget.userId, offset!,
                                    reload: false),
                            itemView: ListView.builder(
                              itemCount:
                                  chatController.messageModel?.message?.length,
          ...
          chatController.hasPicked
              ? Container(
                  color: chatController.isLoading == false &&
                          ((chatController.pickedMediaFileModelList != null &&
                                  chatController
                                      .pickedMediaFileModelList!.isNotEmpty) ||
                              (chatController.pickedFiles != null &&
                                  chatController.pickedFiles!.isNotEmpty))
                      ? Theme.of(context).primaryColor.withValues(alpha: 0.1)
                      : null,
                  height: (chatController.pickedFIleCrossMaxLimit ||
                  ...
                  padding: const EdgeInsets.symmetric(
                      horizontal: 10, vertical: Dimensions.paddingSizeDefault),
                  child: const Center(child: CircularProgressIndicator()),
                )
              : chatController.pickedMediaFileModelList != null &&
                      chatController.pickedMediaFileModelList!.isNotEmpty &&
                          ...
                          SizedBox(
                            ...
                            child: ListView.builder(
                                  ...
                                  children: [
                                    Padding(
                                      padding: const EdgeInsets.only(
                                          ...
                                          left: Dimensions.paddingSizeVeryTiny,
                                    ...
                                    Positioned(
                                      ...
                                      child: InkWell(
                                          ...
                                          child: const CustomAssetImageWidget(
                                              Images.crossImageChat),
                                          onTap: () => chatController
                                              .pickMultipleMedia(true,
                                                  index: index)),
                                    ),
                                  ],
                                );
                              ...
                              itemCount: chatController
                                  .pickedMediaFileModelList!.length,
                            ),
                          ),
                          if (chatController.pickedFIleCrossMaxLimit ||
                              chatController.pickedImageCrossMaxLength ||
                              chatController.singleFIleCrossMaxLimit)
                            Text(
                              "${chatController.pickedImageCrossMaxLength ? "• ${getTranslated('can_not_select_more_than', context)!} ${AppConstants.maxLimitOfTotalFileSent.floor()} 'files' " : ""} "
                            ...
                            itemBuilder: (context, index) {
                              String fileSize =
                                  ImageSize.getFileSizeFromPlatformFileToString(
                                      chatController.pickedFiles![index]);
                              return Container(
                                width: 180,
                                ...
                                child: Row(
                                    ...
                                    children: [
                                      ...
                                      InkWell(
                                        onTap: () {
                                          chatController.pickOtherFile(true,
                                              index: index);
                                        },
                                        child: Padding(
                                          padding:
