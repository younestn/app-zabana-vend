...
class _SendMessageWidgetState extends State<SendMessageWidget> {
  ...
  bool _isSendingButtonActive(ChatController chatController) {
    bool mediaCheck = !chatController.pickedImageCrossMaxLength &&
        !chatController.pickedFIleCrossMaxLength;
    bool textExist = (_controller.text.trim().isNotEmpty ||
        chatController.isSendButtonActive);
    bool limitCheck = !chatController.pickedFIleCrossMaxLimit &&
        !chatController.singleFIleCrossMaxLimit;
    return textExist && mediaCheck && limitCheck;
  }

  void _toggleSendingButtonActive(
      ChatController chatController, String newText) {
    bool isMediaActive =
                      ...
                      child: Container(
                        ...
                        child: TextField(
                          ...
                          onChanged: (String newText) =>
                              _toggleSendingButtonActive(
                                  chatController, newText),
                        ),
                      ),
                    ),
                        ...
                        : GestureDetector(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                border: Border.all(
                                    color:
                                        _isSendingButtonActive(chatController)
