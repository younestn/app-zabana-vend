                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      padding: EdgeInsets.symmetric(
                          horizontal: isDetails
                              ? Dimensions.paddingSizeSmall
                              : Dimensions.paddingSizeOrder,
                          ...
                          ? Row(
                              ...
                              children: [
                                  refundModel!.product == null
                                      ? Expanded(
                                          child: Text(
                                              getTranslated('product_not_found',
                                                      context) ??
                                                  '',
                                              style: robotoRegular.copyWith(
                                                  fontSize: Dimensions
                                        ...
                                        Container(
                                          ...
                                          padding: const EdgeInsets.symmetric(
                                              ...
                                              vertical: Dimensions
                                                  .paddingSizeVeryTiny),
                                          child: Text(
                                              getTranslated(refundModel!.status,
                                                  context)!,
                                              style: robotoRegular.copyWith(
                                                  color: refundModel!.status
                                                              ?.toLowerCase() ==
                      ...
                      ? Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              ((refundModel?.images?.isNotEmpty ?? false) &&
                                      isDetails)
                                  ? RefundAttachmentListWidget(
                                      refundModel: refundModel)
                                  : const SizedBox(),
                            ],
                          ),
                      ...
                      : Container(
                          ...
                          child: Row(
                              ...
                              children: [
                                ...
                                const SizedBox(
                                    width: Dimensions.paddingSizeVeryTiny),
                                Expanded(
                                    child: Text(
                                  refundModel!.refundReason!,
                                  overflow: TextOverflow.ellipsis,
