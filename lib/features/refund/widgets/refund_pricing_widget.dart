          ...
          child: refund.refundDetailsModel != null
              ? Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  ProductCalculationItem(
                      ...
                      price: refund.refundDetailsModel!.productTotalDiscount,
                      isNegative: true),
                  const SizedBox(
                    height: Dimensions.paddingSizeSmall,
                  ),
                  ...
                  if (refund.refundDetailsModel?.referralDiscount != null &&
                      refund.refundDetailsModel!.referralDiscount! > 0) ...[
                    const SizedBox(height: Dimensions.paddingSizeSmall),
                    ProductCalculationItem(
                        title: 'referral_discount',
                        price: refund.refundDetailsModel?.referralDiscount,
                        isNegative: true),
                  ],
                  const SizedBox(height: Dimensions.paddingSizeSmall),
                  Divider(
                  ...
                  Row(children: [
                    ...
                    Text(
                      PriceConverter.convertPrice(
                          context, refund.refundDetailsModel!.refundAmount),
