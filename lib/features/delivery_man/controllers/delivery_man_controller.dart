...
class DeliveryManController extends ChangeNotifier {
  ...
  DeliveryManOrderHistoryModel? get deliverymanOrderList =>
  ...
  final TextEditingController _deliveryManChargeTextEditingController =
      TextEditingController();
  TextEditingController get deliveryManChargeTextEditingController =>
      _deliveryManChargeTextEditingController;
  final TextEditingController _expectedDeliveryDateTextEditingController =
      TextEditingController();
  TextEditingController get expectedDeliveryDateTextEditingController =>
      _expectedDeliveryDateTextEditingController;
  final TextEditingController _thirdPartyShippingNameTextEditingController =
      TextEditingController();
  TextEditingController get thirdPartyShippingNameTextEditingController =>
      _thirdPartyShippingNameTextEditingController;
  final TextEditingController
      _thirdPartyShippingTrackingIdTextEditingController =
      TextEditingController();
  TextEditingController get thirdPartyShippingTrackingIdTextEditingController =>
      _thirdPartyShippingTrackingIdTextEditingController;
  ...
  Future<void> deliveryManListURI(int offset, String search,
      {bool reload = true, bool isUpdate = false}) async {
    if (reload || offset == 1) {
  ...
  Future<void> getDeliveryManOrderList(
    ...
    if (offset == 1) {
      ...
      _deliverymanOrderList!.totalSize =
          DeliveryManOrderHistoryModel.fromJson(apiResponse.response!.data)
              .totalSize;
      _deliverymanOrderList!.offset =
          DeliveryManOrderHistoryModel.fromJson(apiResponse.response!.data)
              .offset;
      _deliverymanOrderList!.orders!.addAll(
          DeliveryManOrderHistoryModel.fromJson(apiResponse.response!.data)
              .orders!);
    }
