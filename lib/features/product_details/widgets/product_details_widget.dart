...
class _ProductDetailsWidgetState extends State<ProductDetailsWidget> {
  ...
  void initState() {
    ...
    Provider.of<ProductDetailsController>(context, listen: false)
        .updateVisibleProductDescription(widget.productModel?.details ?? '',
            isInitialize: true, isUpdate: false);
  }
          ...
          Expanded(
            ...
            child: Column(children: [
              ...
              Container(
                ...
                child: Column(children: [
                  ...
                  if (widget.productModel!.productType == 'physical' &&
                      widget.productModel?.brand?.name != null)
                    _InformationElementWidget(
                        labelText: getTranslated('brand', context)!,
                        infoText: widget.productModel?.brand?.name ?? ''),
                  if (widget.productModel?.category != null &&
                      (widget.productModel?.category?.name?.isNotEmpty ??
                          false))
                    _InformationElementWidget(
                        labelText: getTranslated('category', context)!,
                        infoText: widget.productModel?.category?.name ?? ''),
                  _InformationElementWidget(
                    labelText: getTranslated('product_type', context)!,
                    infoText:
                        '${getTranslated('${widget.productModel?.productType}', context)} ${widget.productModel?.productType == 'digital' ? '(${getTranslated('${widget.productModel?.digitalProductType}', context)})' : ''}',
                  ),
                  widget.productModel!.productType == 'physical'
                      ? _InformationElementWidget(
                          labelText: getTranslated('product_unit', context)!,
                          infoText: widget.productModel?.unit ?? '')
                      : const SizedBox(),
                  widget.productModel!.productType == 'physical'
                      ? _InformationElementWidget(
                          labelText: getTranslated('current_stock', context)!,
                          infoText:
                              widget.productModel?.currentStock.toString() ??
                                  '',
                        )
                      : const SizedBox(),
                  _InformationElementWidget(
              ...
              Container(
                ...
                child: Column(children: [
                  _InformationTitleWidget(
                      title: getTranslated('price_information', context)!),
                  const SizedBox(height: Dimensions.paddingSizeMedium),
                  _InformationElementWidget(
                  ...
                  _InformationElementWidget(
                    ...
                    infoText:
                        '${widget.productModel?.tax?.toString()}% (${getTranslated('${widget.productModel?.taxModel}', context)})',
                    isPercentage: false,
                  ),
                  widget.productModel!.productType == 'physical'
                      ? _InformationElementWidget(
                          labelText: getTranslated('shipping_cost', context)!,
                          infoText: PriceConverter.convertPrice(
                              context,
                              double.tryParse(widget.productModel?.shippingCost
                                          .toString() ??
                                      '') ??
                                  0),
                        )
                  ...
                  isClearanceSaleActive
                      ? _InformationElementWidget(
                          ...
                          infoText: widget.productModel!.clearanceSale!
                                      .discountType ==
                                  'percentage'
                              ? widget
                      ...
                      : _InformationElementWidget(
                          labelText: getTranslated('discount', context)!,
                          infoText:
                              widget.productModel!.discountType == 'percent'
                                  ? widget.productModel!.discount.toString()
                                  : widget.productModel!.discount.toString(),
                          valueWithSign:
                              widget.productModel!.discountType == 'flat',
                          isPercentage:
                              widget.productModel!.discountType == 'percent',
                          showDivider: false,
                        ),
              ...
              if ((widget.productModel?.variation?.isNotEmpty ?? false) ||
                  (widget.productModel?.digitalVariation?.isNotEmpty ??
                      false)) ...[
                Container(
                  padding: const EdgeInsets.all(Dimensions.paddingSizeMedium)
                      .copyWith(bottom: Dimensions.paddingSizeExtraSmall),
                  decoration: BoxDecoration(
                    color: Theme.of(context).cardColor,
                    boxShadow: [
                      BoxShadow(
                  ...
                  child: Column(children: [
                      ...
                      ListView.separated(
                        ...
                        itemBuilder: (context, index) {
                          return _VariationWidget(
                              physicalProduct:
                                  widget.productModel!.variation![index],
                    ...
                    if ((widget.productModel?.digitalVariation?.isNotEmpty ??
                        false))
                      ListView.separated(
                        padding: EdgeInsets.zero,
                        shrinkWrap: true,
                        ...
                        itemBuilder: (context, index) {
                          return _VariationWidget(
                              digitalProduct:
                                  widget.productModel!.digitalVariation![index],
                              productModel: widget.productModel,
                              index: index);
                        },
                        separatorBuilder: (context, index) => Divider(
                            ...
                            thickness: 1),
                        itemCount:
                            widget.productModel!.digitalVariation!.length,
                      ),
                  ]),
                ),
                const SizedBox(height: Dimensions.paddingSizeExtraSmall),
              ...
              /// Description
              if (widget.productModel?.details != null &&
                  widget.productModel!.details!.isNotEmpty)
                  ...
                  return Container(
                    ...
                    child: Column(children: [
                      ...
                      Padding(
                        ...
                        child: InkWell(
                          onTap: () {
                            if ((widget.productModel?.details?.length ?? 0) >
                                300) {
                              productDetailsController
                                  .updateVisibleProductDescription(
              ...
              if ((widget.productModel?.metaSeoInfo?.metaTitle?.isNotEmpty ??
                      false) ||
                  (widget.productModel?.metaSeoInfo?.metaDescription
                          ?.isNotEmpty ??
                      false))
                Column(children: [
                  const SizedBox(height: Dimensions.paddingSizeExtraSmall),
                  Container(
                    ...
                    child: Column(
                        ...
                        children: [
                          _InformationTitleWidget(
                              title: getTranslated(
                                  'product_seo_and_meta_data', context)!),
                          const SizedBox(
                              height: Dimensions.paddingSizeExtraSmall),
                          Text(
                              widget.productModel?.metaSeoInfo?.metaTitle ??
                                  getTranslated(
                                      'meta_title_not_found', context)!,
                          ...
                          const SizedBox(
                              height: Dimensions.paddingSizeExtraSmall),
                          Text(
                              widget.productModel?.metaSeoInfo
                                      ?.metaDescription ??
                                  getTranslated(
                                      'meta_description_not_found', context)!,
                          ...
                          const SizedBox(
                              height: Dimensions.paddingSizeExtraSmall),
                          if (widget.productModel?.metaSeoInfo?.imageFullUrl
                                  ?.path?.isNotEmpty ??
                              false)
                            Container(
                                decoration: BoxDecoration(
                                ...
                                child: ClipRRect(
                                  ...
                                  child: CustomImageWidget(
                                    image: widget.productModel?.metaSeoInfo
                                            ?.imageFullUrl?.path ??
                                        '',
                ...
                Column(children: [
                  ...
                  Container(
                    ...
                    child: Column(
                        ...
                        children: [
                          _InformationTitleWidget(
                              title: getTranslated('product_video', context)!),
                          const SizedBox(
                              height: Dimensions.paddingSizeExtraSmall),
                          Text(
                              widget.productModel?.metaSeoInfo?.metaTitle ??
                                  getTranslated('youtube_video_link', context)!,
                              style: robotoMedium.copyWith(
                                fontSize: Dimensions.fontSizeSmall,
                                color: Theme.of(context)
                                    .textTheme
                          ...
                          InkWell(
                            onTap: () => launchUrl(
                                Uri.parse(widget.productModel?.videoUrl ?? ''),
                                mode: LaunchMode.externalApplication),
                            child: Text(
                              widget.productModel?.videoUrl ?? '',
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              child: Column(
                ...
                Row(
                  children: [
                    ...
                    if (productModel?.digitalProductType == 'ready_product' &&
                        productModel?.digitalFileReady != null &&
                        productModel!.digitalVariation!.isEmpty)
                      Consumer<OrderDetailsController>(
                          builder: (context, orderDetails, _) {
                        return InkWell(
                          onTap: () {
                            _downloadProduct(
                                1, productModel!.digitalFileReadyFullUrl!);
                          },
                          child: Container(
                            decoration: BoxDecoration(
                              borderRadius: BorderRadius.circular(
                            ...
                            child: (orderDetails.isDownloadLoading &&
                                    orderDetails.downloadIndex == 1)
                                ? const SizedBox(
                                    height: 20,
                                    width: 20,
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    borderRadius:
                        BorderRadius.circular(Dimensions.paddingSizeOrder),
                    color: productModel!.requestStatus == 0
                        ? ColorHelper.blendColors(Colors.white,
                            Theme.of(context).colorScheme.outline, 0.2)
                        : productModel!.requestStatus == 1
                            ? ColorHelper.blendColors(
                                ...
                                0.2)
                            : ColorHelper.blendColors(Colors.white,
                                Theme.of(context).colorScheme.error, 0.2),
                  ),
                  child: Text(
                      productModel!.requestStatus == 0
                            ...
                            return GestureDetector(
                              onTap: () {
                                ...
                                final controller = ScrollController(
                                    initialScrollOffset: index * itemWidth);
                                showDialog(
                                  context: context,
                                  builder: (_) {
                                    return ListView.builder(
                                      ...
                                      itemCount:
                                          productModel?.imagesFullUrl?.length,
                                      scrollDirection: Axis.horizontal,
                                      itemBuilder: (context, i) {
                                        return Dialog(
                                          ...
                                          child: SizedBox(
                                            height: heightSize * 0.4,
                                            width: productModel?.imagesFullUrl
                                                        ?.length ==
                                                    1
                                                ? widthSize * 0.8
                                                : widthSize * 0.7,
        ...
        if ((productModel?.deniedNote?.isNotEmpty ?? false) &&
            productModel?.requestStatus == 2)
          Container(
            padding: const EdgeInsets.symmetric(
                horizontal: Dimensions.fontSizeSmall,
            ...
            decoration: BoxDecoration(
              color:
                  Theme.of(context).colorScheme.error.withValues(alpha: 0.125),
              borderRadius: BorderRadius.circular(Dimensions.paddingEye),
            ),
      ...
      child: (widget.physicalProduct != null)
          ? Column(children: [
              Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                Flexible(
                    child: Text(widget.physicalProduct?.type ?? '',
                        style: robotoMedium.copyWith(
                            fontSize: Dimensions.fontSizeSmall,
                            color:
                                Theme.of(context).textTheme.bodyLarge?.color),
              ...
              Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                Flexible(
                    child: Text(
                        PriceConverter.convertPrice(
                            context, widget.physicalProduct?.price),
                        style: robotoMedium.copyWith(
                            fontSize: Dimensions.fontSizeSmall,
                            color: Theme.of(context)
                                .textTheme
                        ...
                        overflow: TextOverflow.ellipsis)),
                const SizedBox(width: Dimensions.paddingSizeDefault),
                Text(widget.physicalProduct?.qty.toString() ?? '0',
                    style: robotoMedium.copyWith(
                      fontSize: Dimensions.fontSizeSmall,
                      color: Theme.of(context).textTheme.bodyLarge?.color,
                    )),
          ...
          : Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
              ...
              Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text(widget.digitalProduct?.variantKey ?? '',
                      style: robotoMedium.copyWith(
                          fontSize: Dimensions.fontSizeSmall,
                          color: Theme.of(context).textTheme.bodyLarge?.color),
                      maxLines: 1,
                      overflow: TextOverflow.ellipsis),
                  if (widget.productModel?.digitalProductType ==
                      'ready_product') ...[
                    const SizedBox(height: Dimensions.paddingSizeSmall),
                    Text(
                        PriceConverter.convertPrice(
                            context, widget.digitalProduct?.price),
                        style: robotoMedium.copyWith(
                          fontSize: Dimensions.fontSizeSmall,
                          color: Theme.of(context).textTheme.bodyLarge?.color,
                        )),
                ...
                Consumer<OrderDetailsController>(
                  ...
                  return InkWell(
                    ...
                    child: Container(
                      ...
                      child: (orderDetails.isDownloadLoading &&
                              orderDetails.downloadIndex == widget.index)
                          ? const SizedBox(
                              height: 20,
                              width: 20,
                              child: CircularProgressIndicator())
