...
class TransactionWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      margin: const EdgeInsets.fromLTRB(Dimensions.paddingSizeSmall, 0,
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Container(
          ...
          child:
            ...
            Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Text(getTranslated('transaction_id', context)!,
        ...
        Container(
          ...
          child: Row(crossAxisAlignment: CrossAxisAlignment.end, children: [
            ...
            const Spacer(),
            if (transactionModel.approved != 1 &&
                transactionModel.approved != 2)
              Consumer<WalletController>(
                ...
                return InkWell(
                  ...
                  child: Container(
                    ...
                    child: Text(getTranslated('cancel_request', context)!,
                        style: robotoBold.copyWith(
                          color: Theme.of(context).cardColor,
                          fontSize: Dimensions.fontSizeSmall,
                        )),
