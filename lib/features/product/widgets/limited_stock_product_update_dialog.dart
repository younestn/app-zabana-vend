...
class LimitedStockQuantityUpdateDialogWidget extends StatefulWidget {
  ...
  const LimitedStockQuantityUpdateDialogWidget(
      {super.key,
      this.title,
  ...
  @override
  State<LimitedStockQuantityUpdateDialogWidget> createState() =>
      _LimitedStockQuantityUpdateDialogWidgetState();
}

class _LimitedStockQuantityUpdateDialogWidgetState
    extends State<LimitedStockQuantityUpdateDialogWidget> {
  int addColor = 0;
  ...
  Widget build(BuildContext context) {
    return Dialog(
        ...
        child:
            Consumer<RestockController>(builder: (context, resProvider, child) {
          List<int> colors = [];
          colors.add(0);
