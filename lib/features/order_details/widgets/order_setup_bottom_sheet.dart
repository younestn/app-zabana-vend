...
class _OrderSetupBottomSheetState extends State<OrderSetupBottomSheet> {
  ...
  void initState() {
    ...
    isSellerWiseShipping = Provider.of<SplashController>(context, listen: false)
            .configModel!
            .shippingMethod ==
        'sellerwise_shipping';
    _getShippingMethod();
  ...
  Widget build(BuildContext context) {
    ...
    final bool isUpdating =
        Provider.of<OrderDetailsController>(context).isUpdating;
                            ...
                            : CustomButtonWidget(
                                ...
                                onTap: () async {
                                  ...
                                  DeliveryManController deliveryManController =
                                      Provider.of<DeliveryManController>(
                                          parentContext,
                                          listen: false);
                                  ...
                                  if (_canUpdate(
                                    ...
                                    final bool isSuccess =
                                      ...
                                      orderSetupModel: orderDetailsController
                                          .orderSetupModel,
                                    );
                                    ...
                                    if (deliveryManController
                                      ...
                                      showToast(
                                          message: getTranslated(
                                              'please_enter_delivery_incentive',
                                              parentContext)!);
                                      return;
                                    } else if (deliveryManController
                                                .selectedDeliveryTypeIndex ==
                                            2 &&
                                        deliveryManController
                                            .thirdPartyShippingNameTextEditingController
                                            .text
                                            .isEmpty) {
                                      showToast(
                                          message: getTranslated(
                                              'please_enter_delivery_service_name',
                                              parentContext)!);
                                      return;
                                    } else if (deliveryManController
                                                .selectedDeliveryTypeIndex ==
                                            2 &&
                                        deliveryManController
                                            .thirdPartyShippingTrackingIdTextEditingController
                                            .text
                                            .isEmpty) {
                                      showToast(
                                          message: getTranslated(
                                              'please_enter_tracking_id',
                                              parentContext)!);
                                      return;
                                    } else {
                                      showToast(
                                          message: getTranslated(
                                              'there_is_no_change_to_update',
                                              parentContext)!);
                                    }
                                  }
                                },
