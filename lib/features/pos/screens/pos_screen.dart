...
class _PosScreenState extends State<PosScreen> {
  ...
  void initState() {
    ...
    Provider.of<CouponDiscountController>(context, listen: false)
        .setSelectedDiscountType('amount');
    Provider.of<CouponDiscountController>(context, listen: false)
        .setDiscountTypeIndex(0, false);
    ...
    if (customerController.customerSelectedName == '') {
      ...
      customerController.setCustomerInfo(0, 'Walk-In Customer', '', false, 0,
          fromInit: true);
    }
  }
          ...
          slivers: [
            SliverToBoxAdapter(child:
              ...
              extraDiscountAmount =
                  Provider.of<CouponDiscountController>(context, listen: false)
                      ...
                      : double.parse(PriceConverter.discountCalculationWithOutSymbol(
                          ...
                          subTotal,
                          extraDiscount,
                          Provider.of<CouponDiscountController>(context, listen: false).selectedDiscountType,
              ...
              total = subTotal -
                  ...
                  couponAmount -
                  double.tryParse(
                      PriceConverter.reverseConvertPriceWithoutSymbol(
                          context, extraDiscountAmount))! +
                  productTax;

              payable = total;

              payableWithoutExDiscount =
                  subTotal - productDiscount - couponAmount + productTax;

              if (isNotSet || cartController.updatePaidAmount) {
                _paidAmountController.text =
                    PriceConverter.convertPriceWithoutSymbol(context, payable);
                ...
                child: Column(
                  children: [
                      ...
                      return Container(
                        ...
                        child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                  '${getTranslated('name', context)}     : ${customerController.customerSelectedName ?? ''}',
                                  maxLines: 1,
                                  ...
                                  style: robotoRegular.copyWith(
                                      color: Theme.of(context)
                                          ...
                                          .bodyLarge
                                          ?.color)),
                              if (customerController.customerSelectedMobile !=
                                      'NULL' &&
                                  customerController.customerSelectedMobile !=
                                      '' &&
                                  cartController.containsNumberExceptZero(
                                      customerController
                                              .customerSelectedMobile ??
                                          '')) ...[
                                Text(
                                    '${getTranslated('phone_no', context)} : ${customerController.customerSelectedMobile != 'NULL' ? customerController.customerSelectedMobile ?? '' : ''}',
                                    style: robotoRegular.copyWith(
                                        color: Theme.of(context)
                                            .textTheme
                                            .bodyLarge
                    ...
                    (cartController.currentCartModel != null &&
                            (cartController.currentCartModel?.cart?.length ??
                                    0) >
                                0)
                        ? Padding(
                                ...
                                children: [
                                                              ...
                                                              children: [
                                                                Positioned(
                                                                  ...
                                                                  child:
                                                                      Material(
                                                                    type: MaterialType
                                                                        .transparency, // Make sure the dialog has material styling
                                                                    child:
                                  ...
                                  Padding(
                                    padding: const EdgeInsets.symmetric(
                                        horizontal:
                                            Dimensions.paddingSizeSmall),
                                    child: Consumer<CustomerController>(builder:
                                        (context, customerProvider, _) {
                                      return SizedBox(
                                          height: 35,
                                  ...
                                  Padding(
                                    ...
                                    child: Container(
                                      padding: const EdgeInsets.symmetric(
                                          horizontal: Dimensions.paddingSeven,
                                      ...
                                      child: Consumer<CustomerController>(
                                          builder:
                                              (context, customerController, _) {
                                        return Column(
                                          crossAxisAlignment:
                                              CrossAxisAlignment.start,
                                          children: [
                                            (cartController.paymentTypeIndex ==
                                                        2 &&
                                                    !customerController
                                                        .checkWalletAmount(
                                                            customerController
                                            ...
                                            Padding(
                                              ...
                                              child: Row(
                                                ...
                                                children: [
                                                  Text(
                                                      '${getTranslated('paid_amount', context)!} :',
                                                      style: robotoRegular
                                                          .copyWith(
                                                              color: Theme.of(
                                                                      context)
                                            ...
                                            child: cartController.isLoading
                                                ...
                                                : Consumer<
                                                    ...
                                                    return CustomButtonWidget(
                                                        ...
                                                        onTap: () {
                                                          debugPrint(
                                                              "===123456====>>${cartController.customerCartList.length}");
                                                          CustomerController
                                                              customerController =
                                                              Provider.of<
                                                                      CustomerController>(
                                                          ...
                                                          if (hasDigitalProduct &&
                                                            ...
                                                            showCustomSnackBarWidget(
                                                                getTranslated(
                                                                    'paid_amount_cannot_less_then_order_amount',
                                                                    context),
                                                                context,
                                                                sanckBarType:
                                                                    SnackBarType
                                                            ...
                                                            showCustomSnackBarWidget(
                                                                getTranslated(
                                                                    'your_wallet_balance_is_less_then_order_amount',
                                                                    context),
                                                                context,
                                                                sanckBarType:
                                                                    SnackBarType
                                                                            ...
                                                                            : () {
                                                                                ...
                                                                                for (int index = 0; index < (cartController.currentCartModel?.cart?.length ?? 0); index++) {
                                                                                  ...
                                                                                  carts.add(Cart(
                                                                                    ...
                                                                                    cart.price.toString(),
                                                                                    cart.product!.discountType == 'flat' ? productDiscount + cart.product!.discount! : productDiscount + ((cart.product!.discount! / 100) * (digitalVPrice ?? cart.product!.unitPrice!)),
                                                                                    cart.quantity,
                                                                                    cart.variant,
                                                                                    cart.varientKey,
                                                                                ...
                                                                                PlaceOrderBody placeOrderBody = PlaceOrderBody(
                                                                                    ...
                                                                                    paymentMethod: cartController.paymentTypeIndex == 0
                                                                                        ? 'cash'
                                                                                        : cartController.paymentTypeIndex == 1
                                                                                            ? 'card'
                                                                                            : 'wallet',
                                                                                    extraDiscount: couponDiscountController.extraDiscountController.text.trim().isEmpty
                                                                                        ? 0.0
                                                                                        : couponDiscountController.selectedDiscountType == 'percent'
                                                                                            ? cartController.currentCartModel?.extraDiscount
                                                                                            : extraDiscountAmount,
                                  ...
                                  const SizedBox(
                                      height:
                                          Dimensions.paddingSizeRevenueBottom),
                                ],
                              ),
                            ),
                          )
  ...
  String getChangeAmount(BuildContext context) {
    ...
    return _sanitizeNegativeZero(
        PriceConverter.convertPrice(context, reversedPaidAmount - totalAmount));
  }

  void _calculateCartDetails(
      CartController cartController, List<CartModel> cartList) {
    for (var cartItem in cartList) {
      double productUnitPrice = _getProductUnitPrice(cartItem);
      int productQuantity = cartItem.quantity ?? 0;

      /// Product Discount
      if (cartItem.product?.clearanceSale != null &&
          cartItem.product?.clearanceSale?.isActive == 1) {
        productDiscount += _calculateClearanceDiscount(
            cartItem, productUnitPrice, productQuantity);
      } else {
        productDiscount +=
            _calculateDiscount(cartItem, productUnitPrice, productQuantity);
      }

      /// Tax Calculation
      if (cartItem.product?.taxModel == "exclude") {
        productTax += ((cartItem.product?.tax ?? 0) / 100) *
            productUnitPrice *
            productQuantity;
  ...
  double _calculateClearanceDiscount(
      CartModel cartItem, double unitPrice, int quantity) {
    if (cartItem.product?.clearanceSale != null &&
        cartItem.product?.clearanceSale?.isActive == 1) {
      double discountAmount =
          cartItem.product?.clearanceSale?.discountAmount ?? 0;
