...
import 'package:sixvalley_vendor_app/common/basewidgets/custom_snackbar_widget.dart'
    show SnackBarType, showCustomSnackBarWidget;
            ...
            children: [
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: DropdownButton<String>(
                            value:
                                couponDiscountController.discountTypeIndex == 0
                                    ? 'amount'
                                    : 'percent',
                            ...
                            onChanged: (value) {
                              ...
                              couponDiscountController.setDiscountTypeIndex(
              ...
              CustomFieldWithTitleWidget(
                customTextField: CustomTextFieldWidget(
                  ...
                  border: true,
                  maxSize: couponDiscountController.discountTypeIndex == 1
                      ? 2
                      : null,
                  isAmount: true,
                ),
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      ...
                      onTap: () async {
                        if ((double.tryParse(couponDiscountController
                          ...
                          showCustomSnackBarWidget(
                              getTranslated(
                                  'discount_amount_must_be_grater_then',
                                  Get.context!),
                              Get.context!,
                          ...
                          couponDiscountController
                              .applyCouponCodeAndExtraDiscount(
                                  context, payable);
                          await Future.delayed(
                              const Duration(milliseconds: 500));
                          Provider.of<CartController>(context, listen: false)
                              .setUpdatePaidAmount(true, isUpdate: true);
                          Navigator.pop(Get.context!);
                        }
                      },
                    )),
