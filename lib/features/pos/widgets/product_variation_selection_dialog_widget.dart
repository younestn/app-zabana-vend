    ...
    return Column(
      ...
      children: [
        Container(
          ...
          child:
              Consumer<CartController>(builder: (ctx, cartController, child) {
            return Consumer<ProductController>(
              builder: (ctx, productProvider, child) {
                ...
                String? variantName = widget.product!.colors!.isNotEmpty
                    ? widget
                        .product!.colors![productProvider.variantIndex!].name
                    : null;
                  ...
                  for (int i = 0;
                    ...
                    if (widget.product!.digitalVariation?[i].variantKey ==
                      ...
                      price = double.tryParse(widget
                          .product!.digitalVariation![i].price
                          .toString());
                    }
                  }
                }
                ...
                if (isUpdate != -1 && productProvider.isUpdateQuantity) {
                  productProvider.setQuantity(
                      cartController
                              .currentCartModel?.cart?[isUpdate].quantity ??
                          1,
                      isUpdate: false);
