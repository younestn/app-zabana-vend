              ...
              itemBuilder: (context, index) {
                double productPrice =
                    Provider.of<CartController>(context, listen: false)
                        .calculateProductPrice(cart![index]);

                String varientKey = '';

                if (cart![index].variant != null &&
                    cart![index].variant != '') {
                  varientKey = cart![index].variant ?? '';
                } else if (cart![index].varientKey != null &&
                    cart![index].varientKey != '') {
                      ...
                      children: [
                        ClipRRect(
                          ...
                          child: CustomImageWidget(
                            image:
                                '${cart![index].product?.thumbnailFullUrl?.path}',
                        ...
                        Padding(
                          padding: const EdgeInsets.symmetric(
                              horizontal: Dimensions.paddingSizeExtraSmall),
                          child: Text(
                            PriceConverter.convertPrice(context, productPrice),
                            style: robotoBold.copyWith(
                                fontSize: Dimensions.fontSizeDefault),
                            maxLines: 1,
                            overflow: TextOverflow.ellipsis,
