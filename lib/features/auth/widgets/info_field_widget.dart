...
class _InfoFieldVIewWidgetState extends State<InfoFieldVIewWidget> {
  ...
  void initState() {
    ...
    authController.validPassCheck(authController.passwordController.text,
        isUpdate: false);
                            ...
                            child: Column(
                              children: [
                                ...
                                CustomTextFieldWidget(
                                  ...
                                  hintText:
                                      '${getTranslated('enter_tin_number', context)}',
                                ...
                                const SizedBox(
                                    height: Dimensions.paddingSizeExtraSmall),
                                Text(
                                    getTranslated('tin_file_size', context) ??
                                        '',
                                    style: robotoRegular.copyWith(
                                        color: Theme.of(context)
                                            .textTheme
