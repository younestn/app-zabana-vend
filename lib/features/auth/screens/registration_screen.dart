              ...
              authController.isLoading
                  ...
                  : Container(
                      ...
                      child: (authController.selectionTabIndex == 1)
                          ? CustomButtonWidget(
                              btnTxt: getTranslated('proceed_to_next', context),
                              onTap: () {
                                          ...
                                          : () async {
                                              if (authController.firstNameController.text
                                                ...
                                                showCustomSnackBarWidget(
                                                    ...
                                                    sanckBarType:
                                                        SnackBarType.warning);
                                              } else if (authController.passwordController.text.trim().length <
                                                  8) {
                                                showCustomSnackBarWidget(
                                                    getTranslated(
                                                        'password_minimum_length_is_6',
                                                ...
                                                RegisterModel registerModel =
                                                  ...
                                                  shopAddress: authController
                                                      ...
                                                      .text
                                                      .trim(),
                                                  businessTin: authController
                                                      .tinNumberController.text
                                                      .trim(),
                                                  tinExpireDate: Provider.of<
                                                              ShopController>(
                                                          context,
                                                          listen: false)
                                                      .tinExpireDate
