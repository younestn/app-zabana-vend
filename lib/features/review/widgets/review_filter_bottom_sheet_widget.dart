                  ...
                  child: CustomButtonWidget(
                      ...
                      onTap: () {
                        if (reviewProvider.startDate == null &&
                          ...
                          showCustomToast(
                              message:
                                  getTranslated('select_all_fields', context)!,
                              context: context,
                              isSuccess: false);
                          ...
                          showCustomToast(
                              message: getTranslated(
                                  'select_start_and_end_time', context)!,
                              context: context,
                              isSuccess: false);
                        } else if (reviewProvider.startDate != null &&
                            reviewProvider.endDate != null &&
                            !isEndDateValid(reviewProvider.startDate!,
                          ...
                          int? productId = Provider.of<ProductReviewController>(
                                  ...
                                  listen: false)
                              .selectedProductId;
                          int? customerId = Provider.of<CustomerController>(
                                  context,
                                  listen: false)
                              .customerId;
