...
class AddProductNextScreenState extends State<AddProductNextScreen> {
  ...
  void initState() {
    ...
    if (_update) {
      ...
      _shippingCostController.text = PriceConverter.convertPriceWithoutSymbol(
          context, _product!.shippingCost);
                  ...
                  if (addColor == 0) {
                    ...
                    if (widget.product!.colors != null &&
                      ...
                      Future.delayed(Duration.zero, () async {
                        Provider.of<VariationController>(Get.context!,
                                listen: false)
                            .setAttribute();
                      });
                    }
                    for (int index = 0;
                      ...
                      colors.add(index);
                      Future.delayed(Duration.zero, () async {
                        variationController.addVariant(
                            Get.context!,
                            0,
                            widget.product!.colors![index].name,
                            widget.product,
                            false);
                        variationController.addColorCode(
                                                        ...
                                                        child: Column(
                                                          ...
                                                          children: [
                                                            ...
                                                            digitalProductController
                                                                    ...
                                                                    .isNotEmpty
                                                                ? SizedBox(
                                                                    height: digitalProductController
                                                                            .selectedDigitalVariation
                                                                            .isNotEmpty
                                                                        ? 40
                                                                        : 0,
                                                                    child: ListView
                                                                        .builder(
                                                                      itemCount: digitalProductController
                                                                          .selectedDigitalVariation
                                                                          .length,
                                                                      scrollDirection:
                                                                          Axis.horizontal,
                                                  ...
                                                  ListView.builder(
                                                    ...
                                                    itemBuilder:
                                                      ...
                                                      return AddProductSectionWidget(
                                                          title:
                                                              '${digitalProductController.selectedDigitalVariation[index]} ${getTranslated('extension', context)!}',
                                                              ...
                                                              child: Column(
                                                                children: [
                                                                    ...
                                                                    onFieldSubmit:
                                                                      ...
                                                                      if (digitalProductController
                                                                          ...
                                                                          .contains(
                                                                              value)) {
                                                                        showCustomSnackBarWidget(
                                                                            getTranslated('extension_already_exists',
                                                                                context),
                                                                            context,
                                                                            sanckBarType:
                                                                                SnackBarType.warning);
                                                                              ...
                                                                              .trim() !=
                                                                          '') {
                                                                        digitalProductController.addExtension(
                                                                            index,
                                                                            value);
                                                                      }
                                                                    },
                                                                  ...
                                                                  digitalProductController
                                                                          ...
                                                                          .isNotEmpty
                                                                      ? SizedBox(
                                                                          height: digitalProductController.digitalVariationExtantion[index].isNotEmpty
                                                                              ? 40
                                                                              : 0,
                                                                          child:
                                                                              ListView.builder(
                                                                            itemCount:
                                                                                digitalProductController.digitalVariationExtantion[index].length,
                                                                            scrollDirection:
                                                                                Axis.horizontal,
                                                                            itemBuilder:
                                                                                (context, i) {
                                                                              return Padding(
                                                                                ...
                                                                                child: Container(
                                                                                  ...
                                                                                  child: Row(children: [
                                                                                    Consumer<SplashController>(builder: (ctx, colorP, child) {
                                                                                      return Text(
                                                                                        digitalProductController.digitalVariationExtantion[index][i],
                                                                                        style: robotoRegular.copyWith(color: ColorHelper.blendColors(Colors.white, Theme.of(context).textTheme.bodyLarge!.color!, 0.7)),
                                                                                      );
                                                                                    }),
                                                                                    const SizedBox(width: Dimensions.paddingSizeSmall),
                                                  ...
                                                  Provider.of<SplashController>(
                                                      ...
                                                      ? Padding(
                                                          padding: const EdgeInsets
                                                              ...
                                                              horizontal: Dimensions
                                                                  .paddingSizeDefault),
                                                          child: DigitalProductWidget(
                                                              resProvider:
                                                                  resProvider,
                                                              product: widget
                                                                  .product,
                                                              fromAddProductNextScreen:
                                                                  true))
                                                      : const SizedBox(),
                                                  digitalProductController
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            crossAxisAlignment:
                                                                                CrossAxisAlignment.start,
                                                                            children: [
                                                                              Text('${digitalProductController.selectedDigitalVariation[index]}-${digitalProductController.digitalVariationExtantion[index][i]} ${getTranslated('file', context)!}', style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeDefault, color: Theme.of(context).textTheme.bodyLarge?.color)),
                                                                                          ...
                                                                                          child: DottedBorder(
                                                                                            ...
                                                                                            child: InkWell(
                                                                                              ...
                                                                                              child: Container(
                                                                                                ...
                                                                                                child: Column(
                                                                                                  mainAxisAlignment: digitalProductController.variationFileList[index][i].fileName == null ? MainAxisAlignment.center : MainAxisAlignment.spaceBetween,
                                                                              ...
                                                                              Provider.of<DigitalProductController>(context, listen: false).digitalProductTypeIndex == 1 ? const SizedBox(height: Dimensions.paddingSizeSmall) : const SizedBox(),
                                                                            ],
                                                                          ),
                                                                        ),
                                                                      );
                      ...
                      child: Row(
                        children: [
                          Expanded(
                            ...
                            onTap: () {
                              Navigator.pop(context);
                              resProvider.setSelectedPageIndex(0,
                                  isUpdate: true);
                            },
                              ...
                              return resProvider.isLoading
                                  ...
                                  : CustomButtonWidget(
                                      ...
                                      onTap: () {
                                        ...
                                        bool digitalProductVariationEmpty =
                                            false;
                                        ...
                                        for (int index = 0;
                                          ...
                                          for (int i = 0;
                                              i <
                                                  digitalProductController
                                                      .variationFileList[index]
                                                      .length;
                                              i++) {
                                            if (digitalProductController
                                                    .variationFileList[index][i]
                                                    .file ==
                                                null) {
                                              isFileEmpty = true;
                                              break;
                                        ...
                                        if (unitPrice.isEmpty) {
                                          showCustomSnackBarWidget(
                                              ...
                                              sanckBarType:
                                                  SnackBarType.warning);
                                        } else if (resProvider.taxTypeIndex ==
                                            -1) {
                                          showCustomSnackBarWidget(
                                              getTranslated(
                                                  'select_tax_model', context),
                                              context,
                                              sanckBarType:
                                                  SnackBarType.warning);
  ...
  Iterable<int> _getColorSuggestionsIndexList({
    ...
    return colors.where((colorIndex) =>
