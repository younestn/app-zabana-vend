...
class AddProductSeoScreenState extends State<AddProductSeoScreen> {
  ...
  Future<void> route(
      bool isRoute, String name, String type, String? colorCode) async {
    if (isRoute) {
      if (type == 'meta') {
        metaImage = name;
          ...
          for (int index = 0;
              index <
                  Provider.of<AddProductImageController>(Get.context!,
                      ...
                      .length;
              index++) {
            String retColor = Provider.of<AddProductImageController>(
                    Get.context!,
                    listen: false)
                .imagesWithColor[index]
                .color!;
            String? bb;
  ...
  Widget build(BuildContext context) {
    final addProductImageController =
        Provider.of<AddProductImageController>(context);
    final resProvider = Provider.of<AddProductController>(context);

    final bool isProcessing = _isSubmittingProduct ||
                      ...
                      return Column(
                        children: [
                                                                          ...
                                                                          child: addProductImageController.selectedLogoFile != null
                                                                              ...
                                                                              : widget.product != null
                                                                                  ? FadeInImage.assetNetwork(
                                                                                      ...
                                                                                      width: 150,
                                                                                      fit: BoxFit.cover,
                                                                                      imageErrorBuilder: (c, o, s) => Image.asset(Images.placeholderImage, height: 160, width: 150, fit: BoxFit.cover, color: Theme.of(context).highlightColor),
                                                                                    )
                                                                                  : Image.asset(
                                                                      ...
                                                                      Positioned(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          onTap: () => addProductImageController.pickImage(
                                                                              ...
                                                                              false,
                                                                              null,
                                                                              isAddProduct: widget.product == null),
                                                                          child:
                                                                              DottedBorder(
                                                                            options:
                                                                    ...
                                                                    children: [
                                                                      Padding(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          borderRadius:
                                                                              BorderRadius.circular(Dimensions.paddingSizeSmall),
                                                                          child: addProductImageController.selectedMetaImageFile != null
                                                                              ? Image.file(
                                                                                  File(addProductImageController.selectedMetaImageFile!.path),
                                                                                  width: 150,
                                                                                  height: 160,
                                                                                  fit: BoxFit.cover,
                                                                                )
                                                                      ...
                                                                      Positioned(
                                                                        ...
                                                                        top: 0,
                                                                        left: 0,
                                                                        child: Consumer<AddProductImageController>(builder: (context,
                                                                            addProductImageController,
                                                                            child) {
                                                                          return InkWell(
                                                                            splashColor:
                                                          ...
                                                          Consumer<
                                                            ...
                                                            return GridView
                                                                .builder(
                                                                    ...
                                                                    itemCount: addProductImageController
                                                                        .imagesWithColor
                                                                        .length,
                                                                    itemBuilder:
                                                                        (context,
                                                                      ...
                                                                      if (addProductImageController
                                                                              ...
                                                                              .color !=
                                                                          null) {
                                                                        if (addProductImageController.imagesWithColor[index].color !=
                                                                            null) {
                                                                          colorString =
                                                                              '0xff${addProductImageController.imagesWithColor[index].color!.substring(1, 7)}';
                                                                        }
                                                                      }
                                                                      ...
                                                                      return Padding(
                                                                        ...
                                                                        child: (addProductImageController.imagesWithColor[index].color != null &&
                                                                                addProductImageController.imagesWithColor[index].image == null)
                                                                            ? GestureDetector(
                                                                                onTap: () async {
                                                                                ...
                                                                                child: Stack(
                                                                                  children: [
                                                                                    DottedBorder(
                                                                                      ...
                                                                                      child: ClipRRect(
                                                                                        borderRadius: BorderRadius.circular(Dimensions.paddingSizeSmall),
                                                                                        child: (_update) ? CustomImageWidget(image: addProductImageController.imagesWithColor[index].colorImage?.imageName?.path ?? "", width: MediaQuery.of(context).size.width / 2.3, height: MediaQuery.of(context).size.width / 2.3, fit: BoxFit.cover) : Image.asset(Images.placeholderImage, height: MediaQuery.of(context).size.width / 2.3, width: MediaQuery.of(context).size.width / 2.3, fit: BoxFit.cover),
                                                                                      ),
                                                                                    ),
                                                                                    Positioned(bottom: 0, right: 0, top: 0, left: 0, child: Align(alignment: Alignment.center, child: Icon(Icons.camera_alt, color: Colors.black.withValues(alpha: .5), size: 40))),
                                                                                    Positioned(right: 5, top: 5, child: Container(width: 30, height: 30, decoration: BoxDecoration(color: Color(int.parse(colorString)), borderRadius: BorderRadius.circular(20)), child: Padding(padding: const EdgeInsets.all(8.0), child: Image.asset(Images.edit))))
                                                                                  ],
                                                                                ),
                                                                              )
                                                                            : Stack(
                                                                                children: [
                                                                                  DottedBorder(
                                                                                      ...
                                                                                      child: Container(
                                                                                          ...
                                                                                          child: ClipRRect(borderRadius: const BorderRadius.all(Radius.circular(Dimensions.paddingSizeSmall)), child: Image.file(File(addProductImageController.imagesWithColor[index].image!.path), width: MediaQuery.of(context).size.width / 2.3, height: MediaQuery.of(context).size.width / 2.3, fit: BoxFit.cover)))),
                                                                                  Positioned(
                                                                                      top: 5,
                                                                                      right: 5,
                                                                                      child: InkWell(
                                                                                          ...
                                                                                          child: Container(width: 30, height: 30, decoration: BoxDecoration(color: Color(int.parse(colorString)), borderRadius: BorderRadius.circular(20)), child: Padding(padding: const EdgeInsets.all(8.0), child: Image.asset(Images.edit))))),
                                                                                ],
                                                                              ),
                                                                      );
                                                                    });
                                                              ...
                                                              .builder(
                                                                  ...
                                                                  itemBuilder:
                                                                      (BuildContext
                                                                          ...
                                                                          index) {
                                                                    return index ==
                                                                            addProductImageController.withoutColor.length
                                                                        ? GestureDetector(
                                                                            onTap: () => addProductImageController.pickImage(
                                                                                false,
                                                                                false,
                                                                                  ...
                                                                                  child: Align(
                                                                                    ...
                                                                                    child: Column(
                                                                                      ...
                                                                                      children: [
                                                                                        ...
                                                                                        Text(
                                                                                          getTranslated('upload_file', context)!,
                                                                                          style: robotoRegular.copyWith(color: Theme.of(context).primaryColor.withValues(alpha: .7)),
                                                                                        )
                                                                                      ],
                                                                                    ),
                                                                                  ),
                                                                              ...
                                                                              DottedBorder(
                                                                                ...
                                                                                child: Container(
                                                                                  ...
                                                                                  child: ClipRRect(
                                                                                    borderRadius: const BorderRadius.all(Radius.circular(Dimensions.paddingSizeSmall)),
                                                                                    child: Image.file(
                                                                                      File(addProductImageController.withoutColor[index].image!.path),
                                                                                      width: MediaQuery.of(context).size.width / 2.3,
                                                                                      height: MediaQuery.of(context).size.width / 2.3,
                                                                                      fit: BoxFit.cover,
                                                                                    ),
                                                                                ...
                                                                                child: InkWell(
                                                                                  ...
                                                                                  child: Container(
                                                                                      decoration: BoxDecoration(
                                                                                          color: Colors.white,
                                                                                          boxShadow: [
                                                                                            BoxShadow(color: Theme.of(context).hintColor.withValues(alpha: .25), blurRadius: 1, spreadRadius: 1, offset: const Offset(0, 0))
                                                                                          ],
                                                                                          borderRadius: const BorderRadius.all(Radius.circular(Dimensions.paddingSizeDefault))),
                                                                                      child: const Padding(
                                                                                        padding: EdgeInsets.all(4.0),
                          ...
                          Consumer<AddProductController>(
                            ...
                            return Consumer<AddProductImageController>(builder:
                                (context, addProductImageController, _) {
                              return Container(
                                height: 80,
                                padding: const EdgeInsets.symmetric(
                                    horizontal: Dimensions.paddingSizeDefault),
                                          ...
                                          Expanded(
                                            child: CustomButtonWidget(
                                              ...
                                              onTap: () async {
                                                ...
                                                final digitalProductController =
                                                    Provider.of<
                                                ...
                                                String multiPlyWithQuantity =
                                                    resProvider.isMultiply
                                                        ? '1'
                                                        : '0';
                                                int multi = int.parse(
                                                    multiPlyWithQuantity);
                                                String productCode = resProvider
                                                    .productCode.text;
                                                ...
                                                if ((!_update && addProductImageController.selectedLogoFile == null) ||
                                                    (_update &&
                                                        (addProductImageController.selectedLogoFile == null &&
                                                            (widget.product?.thumbnailFullUrl?.path == null ||
                                                                widget
                                                                        .product
                                                                        ?.thumbnailFullUrl
                                                                        ?.path ==
                                                  ...
                                                  _addProduct =
                                                      AddProductModel();
                                                  _addProduct!.titleList =
                                                      titleList;
                                                  _addProduct!.descriptionList =
                                                      descriptionList;
                                                  _addProduct!.videoUrl =
                                                      videoUrl;
                                                  _product!.tax =
                                                      _safeDouble(widget.tax);
                                                  _product!
                                                      .taxModel = resProvider
                                                              .taxTypeIndex ==
                                                          0
                                                      ? 'include'
                                                      : 'exclude';
                                                  ...
                                                  _product!.digitalProductType =
                                                      Provider.of<DigitalProductController>(
                                                                      Get
                                                                          .context!,
                                                                      listen:
                                                                          false)
                                                  ...
                                                  try {
                                                    ...
                                                    if (_update) {
                                                      for (ImageModel value
                                                          in addProductImageController
                                                              .imagesWithColor) {
                                                        if (value.image?.path ==
                                                                null &&
                                                            value
  ...
  String _getFilenameFromFullImagePath(String url) {
    ...
    return match?.group(1) ??
        ''; // Returns the captured filename or empty string
  }
}
